...
const
  runeterraLibraryInternal = {Card(`set`: Set1, faction: fIonia, number: 12'u8): CardInfo(
      ...
      `set`: Set1, faction: fIonia, number: 12'u8, subnumber: 2'u8): CardInfo(
      ...
      `set`: Set1, faction: fIonia, number: 12'u8, subnumber: 1'u8): CardInfo(
      name: "Discipline of Force", `type`: ctSpell,
      description: "Give an ally +3|+0 this round.", flavorText: "", cost: 3,
      rarity: crNone, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fIonia, number: 15'u8): CardInfo(name: "Yasuo",
      `type`: ctUnit,
      ...
      Card(`set`: Set1, faction: fIonia, number: 15'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fIonia, number: 15'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 15'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fIonia, number: 15'u8),
      Card(`set`: Set1, faction: fIonia, number: 15'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 15'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fIonia, number: 15'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fIonia, number: 15'u8)]), Card(`set`: Set1,
      faction: fIonia, number: 20'u8): CardInfo(name: "Keeper of Masks",
      `type`: ctUnit,
      ...
      faction: fIonia, number: 45'u8): CardInfo(name: "Herald of Spring",
      `type`: ctUnit,
      ...
      faction: fIonia, number: 8'u8): CardInfo(name: "Fae Bladetwirler",
      `type`: ctUnit,
      ...
      `set`: Set1, faction: fIonia, number: 40'u8): CardInfo(
      ...
      number: 41'u8): CardInfo(name: "Karma", `type`: ctUnit, description: "Round End: Create in hand a spell from your regions.", flavorText: "\"Through reflection, we can focus the mind, and find a path around any obstacle.\"",
                               cost: 6, rarity: crChampion, attack: 4,
                               health: 3,
                               levelupDescription: "You\'re Enlightened.",
                               supertype: csupChampion, associatedCards: @[
      Card(`set`: Set1, faction: fIonia, number: 41'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fIonia, number: 41'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 41'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fIonia, number: 41'u8),
      Card(`set`: Set1, faction: fIonia, number: 41'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 11'u8): CardInfo(name: "Recall",
      ...
      `set`: Set1, faction: fIonia, number: 9'u8): CardInfo(name: "Zed",
      `type`: ctUnit,
      ...
      Card(`set`: Set1, faction: fIonia, number: 9'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fIonia, number: 9'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 9'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fIonia, number: 9'u8),
      Card(`set`: Set1, faction: fIonia, number: 9'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fIonia, number: 9'u8, subnumber: 1'u8)]), Card(
      ...
      Card(`set`: Set1, faction: fIonia, number: 9'u8),
      Card(`set`: Set1, faction: fIonia, number: 9'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 9'u8, subnumber: 1'u8): CardInfo(
      ...
      `set`: Set1, faction: fIonia, number: 14'u8): CardInfo(
      ...
      faction: fIonia, number: 5'u8): CardInfo(name: "Nimble Poro",
      `type`: ctUnit, description: "", flavorText: "\"This might sound crazy, but the last thing I remember was a... fuzzy sensation...?\" - Navori Brigand",
      cost: 1, rarity: crCommon, attack: 1, health: 1, subtypes: {csubPoro},
      keywords: {QuickStrike}), Card(`set`: Set1, faction: fIonia, number: 44'u8): CardInfo(
      ...
      `set`: Set1, faction: fIonia, number: 23'u8): CardInfo(
      ...
      faction: fIonia, number: 29'u8): CardInfo(name: "Sown Seeds",
      ...
      `set`: Set1, faction: fIonia, number: 3'u8): CardInfo(name: "Death Mark",
      `type`: ctSpell,
      ...
      `set`: Set1, faction: fIonia, number: 47'u8): CardInfo(
      name: "Shadow Flare", `type`: ctSpell,
      description: "Grant ALL battling followers Ephemeral.", flavorText: "When the flows of magic are diverted from their balanced state, they surge from the spirit world into the mortal realm--often with startling results.",
      cost: 6, rarity: crEpic, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fIonia, number: 26'u8): CardInfo(
      ...
      faction: fIonia, number: 24'u8): CardInfo(name: "Dawn and Dusk",
      `type`: ctSpell,
      ...
      `set`: Set1, faction: fIonia, number: 28'u8): CardInfo(
      ...
      faction: fIonia, number: 57'u8): CardInfo(name: "Shadow Assassin",
      ...
      `set`: Set1, faction: fIonia, number: 28'u8, subnumber: 2'u8): CardInfo(
      ...
      faction: fIonia, number: 28'u8, subnumber: 1'u8): CardInfo(
      name: "Scaled Snapper", `type`: ctUnit, description: "", flavorText: "One of the oldest inhabitants of the Greenglade, it has withstood the test of time through constant adaptation.",
      cost: 3, rarity: crNone, attack: 2, health: 5), Card(`set`: Set1,
      faction: fIonia, number: 32'u8): CardInfo(name: "Shen", `type`: ctUnit,
      ...
      supertype: csupChampion, associatedCards: @[
      Card(`set`: Set1, faction: fIonia, number: 32'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fIonia, number: 32'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 32'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fIonia, number: 32'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fIonia, number: 32'u8)]), Card(`set`: Set1,
      faction: fIonia, number: 13'u8): CardInfo(name: "Shadow Fiend",
      ...
      `set`: Set1, faction: fIonia, number: 18'u8): CardInfo(name: "Rush",
      `type`: ctSpell,
      ...
      `set`: Set1, faction: fIonia, number: 56'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fIonia, number: 56'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 56'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fIonia, number: 16'u8): CardInfo(name: "Zephyr Sage",
      ...
      faction: fIonia, number: 36'u8): CardInfo(name: "Greenglade Lookout",
      ...
      faction: fIonia, number: 33'u8): CardInfo(name: "Minah Swiftfoot",
      ...
      Card(`set`: Set1, faction: fIonia, number: 33'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 1'u8): CardInfo(
      ...
      `set`: Set1, faction: fIonia, number: 10'u8): CardInfo(
      name: "Stand United", `type`: ctSpell,
      description: "Swap 2 allies. Give them Barrier this round.",
      flavorText: "\"With balanced steps, I go.\" - Shen\n", cost: 6,
      rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fIonia, number: 22'u8): CardInfo(name: "Ghost",
      ...
      cost: 1, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fIonia, number: 21'u8): CardInfo(
      ...
      `set`: Set1, faction: fIonia, number: 54'u8): CardInfo(
      ...
      cost: 2, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fIonia, number: 27'u8): CardInfo(
      ...
      number: 31'u8): CardInfo(name: "Cloud Drinker", `type`: ctUnit,
      ...
      `set`: Set1, faction: fIonia, number: 2'u8): CardInfo(
      name: "Will of Ionia", `type`: ctSpell, description: "Recall a unit.", flavorText: "When invaders first set foot on Ionian soil, they found that conquering the land\'s inhabitants alone would not be enough.",
      cost: 5, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fIonia, number: 33'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set1,
      faction: fIonia, number: 17'u8): CardInfo(name: "Navori Bladescout",
      `type`: ctUnit,
      ...
      cost: 1, rarity: crCommon, attack: 2, health: 1), Card(`set`: Set1,
      faction: fIonia, number: 42'u8): CardInfo(name: "Sparring Student",
      `type`: ctUnit,
      ...
      faction: fIonia, number: 6'u8): CardInfo(name: "Greenglade Duo",
      `type`: ctUnit,
      ...
      `set`: Set1, faction: fIonia, number: 50'u8): CardInfo(
      ...
      faction: fIonia, number: 48'u8): CardInfo(name: "Yusari", `type`: ctUnit,
      ...
      number: 7'u8): CardInfo(name: "Ren Shadowblade", `type`: ctUnit, description: "Strike: Create a Shadow Fiend in hand.", flavorText: "“Run. Fight. Cower. It matters not, the shadows have come for you.”",
                              cost: 4, rarity: crEpic, attack: 3, health: 3,
                              keywords: {QuickStrike}, associatedCards: @[
      Card(`set`: Set1, faction: fIonia, number: 13'u8)]), Card(`set`: Set1,
      faction: fIonia, number: 53'u8): CardInfo(name: "Emerald Awakener",
      ...
      `set`: Set1, faction: fIonia, number: 4'u8): CardInfo(
      name: "Health Potion", `type`: ctSpell,
      description: "Heal an ally or your Nexus 3.", flavorText: "Every generation, region, and family has its own home remedy--though some are undeniably more effective than others.",
      cost: 1, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fIonia, number: 49'u8): CardInfo(name: "Deny",
      `type`: ctSpell, description: "Stop a Fast spell, Slow spell, or Skill.",
      flavorText: "No.", cost: 4, rarity: crRare, spellSpeed: some(ssFast),
      keywords: {Fast}), Card(`set`: Set1, faction: fIonia, number: 52'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fIonia, number: 52'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 52'u8, subnumber: 1'u8): CardInfo(
      ...
      number: 30'u8): CardInfo(name: "The Empyrean", `type`: ctUnit,
      ...
      `set`: Set1, faction: fIonia, number: 19'u8): CardInfo(
      ...
      faction: fIonia, number: 46'u8): CardInfo(name: "Steel Tempest",
      ...
      faction: fIonia, number: 37'u8): CardInfo(name: "Spirit\'s Refuge",
      `type`: ctSpell,
      ...
      `set`: Set1, faction: fIonia, number: 43'u8): CardInfo(
      name: "Rivershaper", `type`: ctUnit, description: "Strike: Draw a spell.", flavorText: "\"We are proud children of the First Lands, and the streams of her magic flow through our vastayan blood as they do through our realm.\"",
      cost: 3, rarity: crRare, attack: 2, health: 2), Card(`set`: Set1,
      faction: fIonia, number: 38'u8): CardInfo(name: "Solitary Monk",
      `type`: ctUnit,
      ...
      `set`: Set1, faction: fIonia, number: 39'u8): CardInfo(
      name: "Shadowshift", `type`: ctSpell,
      ...
      Card(`set`: Set1, faction: fIonia, number: 9'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fIonia, number: 55'u8): CardInfo(
      name: "Ki Guardian", `type`: ctSpell,
      ...
      `set`: Set1, faction: fNoxus, number: 20'u8): CardInfo(name: "Draven",
      `type`: ctUnit,
      ...
      supertype: csupChampion, keywords: {QuickStrike}, associatedCards: @[
      Card(`set`: Set1, faction: fNoxus, number: 20'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fNoxus, number: 20'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fNoxus, number: 20'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 20'u8, subnumber: 3'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fNoxus, number: 20'u8, subnumber: 2'u8),
      ...
      spellSpeed: some(ssFast), supertype: csupChampion, keywords: {Fast}, associatedCards: @[
      Card(`set`: Set1, faction: fNoxus, number: 20'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fNoxus, number: 20'u8)]), Card(`set`: Set1,
      faction: fNoxus, number: 20'u8, subnumber: 1'u8): CardInfo(
      name: "Spinning Axe", `type`: ctSpell,
      ...
      associatedCards: @[Card(`set`: Set1, faction: fNoxus, number: 20'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 6'u8): CardInfo(name: "Vladimir",
      ...
      supertype: csupChampion, associatedCards: @[
      Card(`set`: Set1, faction: fNoxus, number: 6'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fNoxus, number: 6'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fNoxus, number: 6'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 6'u8, subnumber: 4'u8): CardInfo(
      ...
      keywords: {Skill},
      associatedCards: @[Card(`set`: Set1, faction: fNoxus, number: 6'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 6'u8, subnumber: 2'u8): CardInfo(
      ...
      keywords: {Skill},
      associatedCards: @[Card(`set`: Set1, faction: fNoxus, number: 6'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 6'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fNoxus, number: 32'u8),
      Card(`set`: Set1, faction: fNoxus, number: 48'u8),
      Card(`set`: Set1, faction: fNoxus, number: 5'u8),
      Card(`set`: Set1, faction: fNoxus, number: 30'u8)]), Card(`set`: Set1,
      faction: fNoxus, number: 38'u8): CardInfo(name: "Darius", `type`: ctUnit,
      ...
      Card(`set`: Set1, faction: fNoxus, number: 38'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 23'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 13'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 46'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fNoxus, number: 46'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 46'u8, subnumber: 1'u8): CardInfo(
      ...
      number: 47'u8): CardInfo(name: "Transfusion", `type`: ctSpell, description: "Deal 1 to an ally to give another ally +2|+2 this round.", flavorText: "\"It\'s give and take, my dear. You give, and I take.\" - Vladimir",
                               cost: 2, rarity: crCommon,
                               spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fNoxus, number: 40'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fNoxus, number: 40'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 38'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fNoxus, number: 38'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fNoxus, number: 38'u8)]), Card(`set`: Set1,
      faction: fNoxus, number: 25'u8): CardInfo(name: "Brothers\' Bond",
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fNoxus, number: 55'u8): CardInfo(
      name: "House Spider", `type`: ctUnit,
      description: "When I\'m summoned, summon a Spiderling.", flavorText: "\"My spiders love company. Shame that company never feels the same.\" - Elise",
      cost: 2, rarity: crCommon, attack: 2, health: 2, subtypes: {csubSpider}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 2'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 30'u8): CardInfo(
      ...
      faction: fNoxus, number: 9'u8): CardInfo(name: "Crowd Favorite",
      ...
      `set`: Set1, faction: fNoxus, number: 11'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 53'u8): CardInfo(name: "Reckoning",
      ...
      `set`: Set1, faction: fNoxus, number: 40'u8, subnumber: 1'u8): CardInfo(
      name: "Sabotage", `type`: ctAbility,
      description: "Deal 1 to the enemy Nexus.",
      flavorText: "\"Boom.\" - Legion Saboteur", cost: 0, rarity: crNone,
      keywords: {Skill}), Card(`set`: Set1, faction: fNoxus, number: 54'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 29'u8): CardInfo(
      ...
      faction: fNoxus, number: 14'u8): CardInfo(name: "Shiraza the Blade",
      ...
      faction: fNoxus, number: 42'u8): CardInfo(name: "Katarina",
      `type`: ctUnit,
      ...
      supertype: csupChampion, keywords: {QuickStrike}, associatedCards: @[
      Card(`set`: Set1, faction: fNoxus, number: 43'u8),
      Card(`set`: Set1, faction: fNoxus, number: 42'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fNoxus, number: 42'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 42'u8, subnumber: 2'u8): CardInfo(
      ...
      spellSpeed: some(ssFast), supertype: csupChampion, keywords: {Fast}, associatedCards: @[
      Card(`set`: Set1, faction: fNoxus, number: 42'u8),
      Card(`set`: Set1, faction: fNoxus, number: 42'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 51'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set1, faction: fNoxus, number: 2'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 12'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 43'u8): CardInfo(
      name: "Blade\'s Edge", `type`: ctSpell,
      description: "Deal 1 to anything.", flavorText: "\"In the right hands, a blade can cut through anything... and I do mean anything.\" - Katarina",
      cost: 1, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fNoxus, number: 37'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 10'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 17'u8): CardInfo(
      ...
      faction: fNoxus, number: 3'u8): CardInfo(name: "Arena Bookie",
      `type`: ctUnit,
      ...
      cost: 2, rarity: crRare, attack: 2, health: 2), Card(`set`: Set1,
      faction: fNoxus, number: 39'u8): CardInfo(name: "Vision", `type`: ctSpell,
      ...
      `set`: Set1, faction: fNoxus, number: 41'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 36'u8): CardInfo(
      ...
      faction: fNoxus, number: 44'u8): CardInfo(name: "Battering Ram",
      ...
      `set`: Set1, faction: fNoxus, number: 5'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, attack: 2, health: 2), Card(`set`: Set1,
      faction: fNoxus, number: 16'u8): CardInfo(name: "Trifarian Hopeful",
      ...
      cost: 2, rarity: crCommon, attack: 3, health: 2), Card(`set`: Set1,
      faction: fNoxus, number: 19'u8): CardInfo(name: "Might", `type`: ctSpell,
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fNoxus, number: 15'u8): CardInfo(
      name: "Precious Pet", `type`: ctUnit, description: "",
      flavorText: "She loves them all. She just loves this one more.", cost: 1,
      rarity: crCommon, attack: 2, health: 1, subtypes: {csubSpider},
      keywords: {Fearsome}), Card(`set`: Set1, faction: fNoxus, number: 50'u8): CardInfo(
      ...
      spellSpeed: some(ssFast), keywords: {Fast}), Card(`set`: Set1,
      faction: fNoxus, number: 56'u8): CardInfo(name: "Shunpo", `type`: ctSpell,
      ...
      `set`: Set1, faction: fNoxus, number: 33'u8): CardInfo(
      ...
      faction: fNoxus, number: 52'u8): CardInfo(name: "Blood for Blood",
      ...
      `set`: Set1, faction: fNoxus, number: 45'u8): CardInfo(
      ...
      number: 31'u8): CardInfo(name: "Trifarian Gloryseeker", `type`: ctUnit,
      ...
      `set`: Set1, faction: fNoxus, number: 2'u8): CardInfo(name: "Decimate",
      ...
      cost: 5, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set1, faction: fNoxus, number: 8'u8): CardInfo(
      name: "Basilisk Rider", `type`: ctUnit,
      description: "Allegiance: Grant me +1|+1 and Overwhelm.", flavorText: "This particular unit does use horses, just not for riding. The beasts find them delicious.",
      cost: 4, rarity: crRare, attack: 4, health: 3), Card(`set`: Set1,
      faction: fNoxus, number: 34'u8): CardInfo(name: "Affectionate Poro",
      `type`: ctUnit, description: "", flavorText: "\"Noxus has no room for... for weakn--Will someone get this DAMNED THING OFF ME?!\" - Darius",
      cost: 1, rarity: crCommon, attack: 1, health: 1, subtypes: {csubPoro},
      keywords: {Challenger}), Card(`set`: Set1, faction: fNoxus, number: 35'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set1, faction: fNoxus, number: 20'u8)]), Card(
      `set`: Set1, faction: fNoxus, number: 26'u8): CardInfo(
      ...
      `set`: Set1, faction: fNoxus, number: 27'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fNoxus, number: 22'u8): CardInfo(
      ...
      spellSpeed: some(ssFast), keywords: {Fast}), Card(`set`: Set1,
      faction: fNoxus, number: 32'u8): CardInfo(name: "Crimson Awakener",
      `type`: ctUnit,
      ...
      faction: fNoxus, number: 24'u8): CardInfo(name: "Kato The Arm",
      ...
      faction: fNoxus, number: 49'u8): CardInfo(name: "Guile", `type`: ctSpell,
      ...
      `set`: Set1, faction: fDemacia, number: 31'u8): CardInfo(
      ...
      faction: fDemacia, number: 22'u8): CardInfo(name: "Lucian",
      ...
      supertype: csupChampion, keywords: {QuickStrike}, associatedCards: @[
      Card(`set`: Set1, faction: fDemacia, number: 38'u8),
      Card(`set`: Set1, faction: fDemacia, number: 22'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fDemacia, number: 22'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 19'u8): CardInfo(name: "Mobilize",
      `type`: ctSpell,
      ...
      cost: 3, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fDemacia, number: 42'u8): CardInfo(name: "Lux",
      ...
      Card(`set`: Set1, faction: fDemacia, number: 42'u8, subnumber: 2'u8),
      ...
      Card(`set`: Set1, faction: fDemacia, number: 42'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 42'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fDemacia, number: 42'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fDemacia, number: 42'u8, subnumber: 3'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 42'u8, subnumber: 3'u8): CardInfo(
      ...
      faction: fDemacia, number: 10'u8): CardInfo(name: "Swiftwing Lancer",
      `type`: ctUnit,
      ...
      number: 20'u8): CardInfo(name: "Vanguard Defender", `type`: ctUnit,
      ...
      `set`: Set1, faction: fDemacia, number: 34'u8): CardInfo(
      name: "Battlesmith", `type`: ctUnit,
      description: "When you summon an Elite, grant it +1|+1.",
      flavorText: "Wars are won in the forge.", cost: 2, rarity: crRare,
      attack: 2, health: 2), Card(`set`: Set1, faction: fDemacia, number: 2'u8): CardInfo(
      ...
      `set`: Set1, faction: fDemacia, number: 12'u8): CardInfo(name: "Garen",
      ...
      Card(`set`: Set1, faction: fDemacia, number: 12'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fDemacia, number: 12'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 12'u8, subnumber: 1'u8): CardInfo(
      ...
      spellSpeed: some(ssFast), supertype: csupChampion, keywords: {Fast}, associatedCards: @[
      Card(`set`: Set1, faction: fDemacia, number: 12'u8),
      Card(`set`: Set1, faction: fDemacia, number: 12'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 17'u8): CardInfo(
      name: "Stand Alone", `type`: ctSpell,
      ...
      `set`: Set1, faction: fDemacia, number: 45'u8): CardInfo(name: "Fiora",
      ...
      Card(`set`: Set1, faction: fDemacia, number: 45'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fDemacia, number: 45'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 52'u8): CardInfo(
      ...
      faction: fDemacia, number: 21'u8): CardInfo(name: "Relentless Pursuit",
      ...
      supertype: csupChampion, keywords: {Slow}, associatedCards: @[
      Card(`set`: Set1, faction: fDemacia, number: 22'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fDemacia, number: 22'u8)]), Card(`set`: Set1,
      faction: fDemacia, number: 22'u8, subnumber: 1'u8): CardInfo(
      name: "Lucian", `type`: ctUnit,
      ...
      Card(`set`: Set1, faction: fDemacia, number: 22'u8),
      Card(`set`: Set1, faction: fDemacia, number: 22'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 25'u8): CardInfo(name: "Detain",
      ...
      faction: fDemacia, number: 48'u8): CardInfo(name: "Mageseeker Inciter",
      ...
      cost: 4, rarity: crRare, attack: 4, health: 3), Card(`set`: Set1,
      faction: fDemacia, number: 1'u8): CardInfo(name: "Vanguard Bannerman",
      ...
      `set`: Set1, faction: fDemacia, number: 43'u8): CardInfo(
      name: "War Chefs", `type`: ctUnit,
      ...
      faction: fDemacia, number: 49'u8): CardInfo(name: "Plucky Poro",
      ...
      cost: 1, rarity: crCommon, attack: 1, health: 1, subtypes: {csubPoro},
      keywords: {Tough}), Card(`set`: Set1, faction: fDemacia, number: 53'u8): CardInfo(
      ...
      faction: fDemacia, number: 33'u8): CardInfo(name: "Remembrance",
      ...
      cost: 6, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set1, faction: fDemacia, number: 45'u8, subnumber: 1'u8): CardInfo(
      ...
      supertype: csupChampion, keywords: {Burst}, associatedCards: @[
      Card(`set`: Set1, faction: fDemacia, number: 45'u8),
      Card(`set`: Set1, faction: fDemacia, number: 45'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 44'u8): CardInfo(
      ...
      cost: 6, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set1, faction: fDemacia, number: 24'u8): CardInfo(
      ...
      `set`: Set1, faction: fDemacia, number: 4'u8): CardInfo(
      ...
      keywords: {Challenger}), Card(`set`: Set1, faction: fDemacia,
                                    number: 11'u8): CardInfo(
      ...
      `set`: Set1, faction: fDemacia, number: 47'u8): CardInfo(
      name: "Succession", `type`: ctSpell,
      description: "Summon a Dauntless Vanguard.", flavorText: "Vestments of the Dauntless Vanguard are handed down from one soldier to the next, so that new recruits may feel the weight and pride of their responsibilities.",
      cost: 3, rarity: crCommon, spellSpeed: some(ssSlow), keywords: {Slow},
      associatedCards: @[Card(`set`: Set1, faction: fDemacia, number: 16'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 46'u8): CardInfo(
      ...
      `set`: Set1, faction: fDemacia, number: 50'u8): CardInfo(name: "Purify",
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fDemacia, number: 16'u8): CardInfo(
      ...
      `set`: Set1, faction: fDemacia, number: 40'u8): CardInfo(
      ...
      faction: fDemacia, number: 36'u8): CardInfo(name: "Vanguard Squire",
      `type`: ctUnit,
      ...
      `set`: Set1, faction: fDemacia, number: 37'u8): CardInfo(name: "Riposte",
      `type`: ctSpell,
      description: "Give an ally +3|+0 and Barrier this round.",
      flavorText: "\"How appropriate--you fight like a poro!\" - Fiora",
      cost: 4, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fDemacia, number: 14'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set1, faction: fDemacia, number: 16'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 15'u8): CardInfo(
      ...
      faction: fDemacia, number: 3'u8): CardInfo(name: "Laurent Bladekeeper",
      ...
      cost: 4, rarity: crRare, attack: 2, health: 3), Card(`set`: Set1,
      faction: fDemacia, number: 26'u8): CardInfo(name: "Single Combat",
      ...
      rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fDemacia, number: 32'u8): CardInfo(
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fDemacia, number: 27'u8): CardInfo(name: "En Garde",
      ...
      cost: 3, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fDemacia, number: 6'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set1, faction: fDemacia, number: 35'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 38'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set1, faction: fDemacia, number: 22'u8)]), Card(
      `set`: Set1, faction: fDemacia, number: 41'u8): CardInfo(
      ...
      `set`: Set1, faction: fDemacia, number: 35'u8): CardInfo(
      ...
      cost: 6, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set1, faction: fDemacia, number: 18'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fDemacia, number: 9'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, attack: 3, health: 2), Card(`set`: Set1,
      faction: fDemacia, number: 39'u8): CardInfo(name: "Cithria of Cloudfield",
      ...
      `set`: Set1, faction: fDemacia, number: 56'u8): CardInfo(
      ...
      `set`: Set1, faction: fDemacia, number: 29'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, attack: 2, health: 1), Card(`set`: Set1,
      faction: fDemacia, number: 28'u8): CardInfo(name: "Vanguard Cavalry",
      ...
      keywords: {Tough}), Card(`set`: Set1, faction: fDemacia, number: 13'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fDemacia, number: 23'u8): CardInfo(
      ...
      `set`: Set1, faction: fDemacia, number: 30'u8): CardInfo(
      ...
      keywords: {Elusive, Tough}), Card(`set`: Set1, faction: fPiltoverZaun,
                                        number: 40'u8): CardInfo(name: "Jinx",
      ...
      keywords: {QuickStrike}, associatedCards: @[Card(`set`: Set1,
      faction: fPiltoverZaun, number: 40'u8, subnumber: 2'u8), Card(`set`: Set1,
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 40'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 40'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 40'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 40'u8, subnumber: 1'u8): CardInfo(
      ...
      keywords: {QuickStrike}, associatedCards: @[Card(`set`: Set1,
      faction: fPiltoverZaun, number: 40'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 40'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 40'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 8'u8): CardInfo(
      name: "Teemo", `type`: ctUnit, description: "Nexus Strike: Plant 5 Poison Puffcaps on random cards in the enemy deck.", flavorText: "\"Bandle Scout Rule 154: Never fear the unknown! Rule 276: Denizens of the woodlands are our friends! Rule 354: If it\'s fuzzy, it might be safe to pet but certainly isn\'t safe to eat! Rule 417...\"",
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 8'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 8'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 8'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 8'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 8'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 22'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8): CardInfo(
      name: "Heimerdinger", `type`: ctUnit, description: "When you cast a spell, create a Fleeting Turret in hand with equal cost. It costs 0 this round.", flavorText: "\"Mad scientist? Pft! I\'m clearly a very-stable-if-slightly-disorganized-and-eclectic scientist, thank you very much!\"",
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 56'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 3'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 1'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 4'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 7'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 8'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 9'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 2'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 6'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 5'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 15'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 13'u8): CardInfo(
      ...
      health: 4, supertype: csupChampion, keywords: {Imbue}, associatedCards: @[Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 3'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 1'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 4'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 7'u8), Card(
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 6'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 5'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 15'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 56'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 7'u8): CardInfo(
      ...
      keywords: {Tough}), Card(`set`: Set1, faction: fPiltoverZaun,
                               number: 56'u8, subnumber: 9'u8): CardInfo(
      name: "Mk4: Stormlobber", `type`: ctUnit, description: "", flavorText: "\"PROGRESS CONTINUES! I have finally found a way to combine the raw power of hexenergy with my ball tosser! I present, the STORMLOBBER! Now to sleep.\"\n- Heimerdinger\'s Lab Notes, Vol. 4",
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 56'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 8'u8): CardInfo(
      ...
      keywords: {Fearsome}), Card(`set`: Set1, faction: fPiltoverZaun,
                                  number: 56'u8, subnumber: 2'u8): CardInfo(
      ...
      keywords: {QuickStrike}), Card(`set`: Set1, faction: fPiltoverZaun,
                                     number: 56'u8, subnumber: 5'u8): CardInfo(
      ...
      keywords: {Barrier}), Card(`set`: Set1, faction: fPiltoverZaun,
                                 number: 56'u8, subnumber: 1'u8): CardInfo(
      ...
      keywords: {Challenger}), Card(`set`: Set1, faction: fPiltoverZaun,
                                    number: 56'u8, subnumber: 4'u8): CardInfo(
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 56'u8, subnumber: 6'u8): CardInfo(
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 19'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, attack: 2, health: 1), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 25'u8): CardInfo(name: "Puffcap Peddler",
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 32'u8): CardInfo(name: "Scrap Scuttler",
      ...
      faction: fPiltoverZaun, number: 15'u8): CardInfo(name: "T-Hex",
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 22'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Autoplay}, associatedCards: @[
      Card(`set`: Set1, faction: fPiltoverZaun, number: 8'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 28'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 32'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 50'u8): CardInfo(
      name: "Rising Spell Force", `type`: ctSpell,
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 54'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 54'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 54'u8, subnumber: 1'u8): CardInfo(
      ...
      keywords: {Skill}), Card(`set`: Set1, faction: fPiltoverZaun,
                               number: 30'u8): CardInfo(name: "Shady Character",
      `type`: ctUnit, description: "Play: Pick a follower. Transform me into an exact copy of it.",
      flavorText: "\"Hello, fellow Chem-Barons!\"", cost: 4, rarity: crRare,
      attack: 1, health: 3, associatedCards: @[
      Card(`set`: Set1, faction: fPiltoverZaun, number: 30'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 30'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 17'u8): CardInfo(
      name: "Used Cask Salesman", `type`: ctUnit,
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 47'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 38'u8): CardInfo(
      name: "Sump Dredger", `type`: ctUnit,
      ...
      faction: fPiltoverZaun, number: 36'u8): CardInfo(name: "Ezreal",
      `type`: ctUnit,
      ...
      supertype: csupChampion, keywords: {Elusive}, associatedCards: @[Card(
      `set`: Set1, faction: fPiltoverZaun, number: 36'u8, subnumber: 2'u8), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 36'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 52'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 36'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 52'u8),
      ...
      supertype: csupChampion, keywords: {Fast}, associatedCards: @[
      Card(`set`: Set1, faction: fPiltoverZaun, number: 36'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 36'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 35'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 10'u8): CardInfo(name: "Mushroom Cloud",
      ...
      cost: 1, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}, associatedCards: @[
      Card(`set`: Set1, faction: fPiltoverZaun, number: 22'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 45'u8): CardInfo(
      name: "Zaunite Urchin", `type`: ctUnit,
      description: "Play: Discard a card to draw 1.", flavorText: "\"You\'d think the sumprats would look after their own.\"\n\"Too busy basking in their self-pity, brother.\"\n\"Shame. Ah... have you seen my purse?\"",
      cost: 1, rarity: crCommon, attack: 2, health: 1), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 13'u8, subnumber: 1'u8): CardInfo(
      ...
      keywords: {Skill}), Card(`set`: Set1, faction: fPiltoverZaun, number: 2'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 4'u8): CardInfo(name: "Trueshot Barrage",
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 20'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 33'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 33'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 33'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 5'u8): CardInfo(
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 21'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 31'u8): CardInfo(name: "Statikk Shock",
      ...
      cost: 1, rarity: crCommon, attack: 1, health: 2), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 14'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 14'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 34'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 26'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 14'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 60'u8): CardInfo(
      ...
      cost: 5, rarity: crEpic, spellSpeed: some(ssSlow), keywords: {Slow}, associatedCards: @[
      Card(`set`: Set1, faction: fPiltoverZaun, number: 33'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 3'u8): CardInfo(
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 44'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 44'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 29'u8): CardInfo(
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 51'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 44'u8, subnumber: 2'u8): CardInfo(
      name: "Face-Melter", `type`: ctAbility,
      description: "Deal 1 to all enemies.",
      flavorText: "\"Let the show begin!\" - Chempunk Shredder", cost: 0,
      rarity: crNone, keywords: {Skill}), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 23'u8): CardInfo(
      name: "Professor von Yipp", `type`: ctUnit,
      ...
      cost: 4, rarity: crRare, attack: 2, health: 3), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 24'u8): CardInfo(
      name: "Unstable Voltician", `type`: ctUnit, description: "Grant me +4|+0 and Quick Attack once you\'ve cast a 6+ cost spell this game.", flavorText: "Name: Klas Henwick, Age: 51, License Type: Class 2 Conditional, Status: Revoked, Comments: Ignored repeated warnings to reduce output following lab explosion (Case 13X764NM). DO NOT PERMIT ENTRY.",
      cost: 5, rarity: crRare, attack: 4, health: 4), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 49'u8): CardInfo(name: "Progress Day!",
      `type`: ctSpell,
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 6'u8): CardInfo(
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 53'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fPiltoverZaun, number: 10'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 22'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 12'u8): CardInfo(
      name: "Flame Chompers!", `type`: ctUnit,
      ...
      faction: fPiltoverZaun, number: 39'u8): CardInfo(name: "Get Excited!",
      `type`: ctSpell,
      description: "To play, discard 1.\c\nDeal 3 to anything.",
      flavorText: "\"FIRE IN THE CABOODLE!\" - Jinx", cost: 3, rarity: crRare,
      spellSpeed: some(ssFast), keywords: {Fast}), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 16'u8): CardInfo(
      name: "Flash of Brilliance", `type`: ctSpell, description: "Create in hand a 6+ cost spell from your regions.\c\nRefill your spell mana.",
      ...
      `set`: Set1, faction: fPiltoverZaun, number: 58'u8): CardInfo(
      ...
      cost: 4, rarity: crRare, attack: 4, health: 3, associatedCards: @[
      Card(`set`: Set1, faction: fPiltoverZaun, number: 22'u8),
      Card(`set`: Set1, faction: fPiltoverZaun, number: 10'u8)]), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 9'u8): CardInfo(
      name: "Amateur Aeronaut", `type`: ctUnit, description: "", flavorText: "\"Personal flying machines? A pipe dream! I just had my apprentice throw the latest prototype out, in fact. Now, where is he?\" - Piltovan engineer",
      cost: 3, rarity: crCommon, attack: 2, health: 3, keywords: {Elusive}), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 42'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 26'u8): CardInfo(name: "Sumpworks Map",
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fPiltoverZaun, number: 43'u8): CardInfo(
      ...
      cost: 2, rarity: crRare, attack: 3, health: 2), Card(`set`: Set1,
      faction: fPiltoverZaun, number: 47'u8): CardInfo(name: "Caustic Cask",
      ...
      number: 24'u8): CardInfo(name: "Anivia", `type`: ctUnit, description: "Attack: Deal 1 to all enemies and the enemy Nexus.\c\nLast Breath: Revive me transformed into Eggnivia.", flavorText: "\"I was born from this hard land, and it is mine to safeguard. Time, war, even death itself will not stop my vigil.\"",
                               cost: 6, rarity: crChampion, attack: 2,
                               health: 4,
                               levelupDescription: "You\'re Enlightened.",
                               supertype: csupChampion, keywords: {LastBreath}, associatedCards: @[
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 4'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fFreljord, number: 24'u8),
      ...
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 4'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8)]), Card(`set`: Set1,
      faction: fFreljord, number: 24'u8, subnumber: 3'u8): CardInfo(
      name: "Anivia", `type`: ctUnit, description: "Attack: Deal 2 to all enemies and the enemy Nexus.\c\nLast Breath: Revive me transformed into Eggnivia.", flavorText: "\"Cease your march and turn back your armies. The eye of winter has spied your conquest, and its icy claw closes tight about your treasonous hearts.\" ",
      cost: 6, rarity: crNone, attack: 3, health: 5, supertype: csupChampion,
      keywords: {LastBreath}, associatedCards: @[
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 5'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 4'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 5'u8): CardInfo(
      name: "Glacial Storm", `type`: ctAbility,
      ...
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8)]), Card(`set`: Set1,
      faction: fFreljord, number: 24'u8, subnumber: 4'u8): CardInfo(
      name: "Eggnivia", `type`: ctUnit, description: "", flavorText: "In the depths of winter\'s cold embrace, the Freljord\'s guardian awaits the hour of her return.",
      ...
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fFreljord, number: 24'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 39'u8): CardInfo(
      ...
      cost: 8, rarity: crNone, spellSpeed: some(ssBurst),
      supertype: csupChampion, keywords: {Burst}, associatedCards: @[
      Card(`set`: Set1, faction: fFreljord, number: 39'u8),
      Card(`set`: Set1, faction: fFreljord, number: 39'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 39'u8, subnumber: 2'u8): CardInfo(
      name: "Tryndamere", `type`: ctUnit, description: "",
      ...
      Card(`set`: Set1, faction: fFreljord, number: 39'u8),
      Card(`set`: Set1, faction: fFreljord, number: 39'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 6'u8): CardInfo(
      ...
      cost: 5, rarity: crCommon, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set1, faction: fFreljord, number: 22'u8): CardInfo(
      name: "Omen Hawk", `type`: ctUnit, description: "When I\'m summoned, grant the top 2 allies in your deck +1|+1.", flavorText: "\"Three times our reavers reached Avarosan gates, and three time they were met with ready bows. What trickery warns them of our attacks?\" - Scarthane Steffen",
      cost: 1, rarity: crCommon, attack: 1, health: 1), Card(`set`: Set1,
      faction: fFreljord, number: 42'u8): CardInfo(name: "Harsh Winds",
      ...
      cost: 6, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fFreljord, number: 9'u8): CardInfo(name: "Braum",
      `type`: ctUnit,
      ...
      Card(`set`: Set1, faction: fFreljord, number: 53'u8),
      Card(`set`: Set1, faction: fFreljord, number: 9'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fFreljord, number: 9'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 18'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 36'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fFreljord, number: 36'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 45'u8): CardInfo(
      ...
      cost: 3, rarity: crCommon, attack: 2, health: 4), Card(`set`: Set1,
      faction: fFreljord, number: 8'u8): CardInfo(name: "Lonely Poro",
      ...
      `set`: Set1, faction: fFreljord, number: 8'u8, subnumber: 1'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 55'u8): CardInfo(name: "Shatter",
      ...
      `set`: Set1, faction: fFreljord, number: 38'u8): CardInfo(name: "Ashe",
      ...
      Card(`set`: Set1, faction: fFreljord, number: 38'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fFreljord, number: 38'u8, subnumber: 3'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 38'u8, subnumber: 3'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 38'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fFreljord, number: 38'u8, subnumber: 3'u8),
      Card(`set`: Set1, faction: fFreljord, number: 38'u8, subnumber: 1'u8),
      ...
      Card(`set`: Set1, faction: fFreljord, number: 38'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fFreljord, number: 38'u8)]), Card(`set`: Set1,
      faction: fFreljord, number: 29'u8): CardInfo(name: "Entreat",
      ...
      cost: 2, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fFreljord, number: 35'u8): CardInfo(
      ...
      faction: fFreljord, number: 28'u8): CardInfo(name: "Enraged Yeti",
      `type`: ctUnit, description: "",
      flavorText: "Yetis? I just don\'t think they exi--AUGHHH!", cost: 1,
      rarity: crNone, attack: 5, health: 5, subtypes: {csubYeti}), Card(
      `set`: Set1, faction: fFreljord, number: 20'u8): CardInfo(
      name: "Avalanche", `type`: ctSpell, description: "Deal 2 to ALL units.", flavorText: "The soul of every avalanche is a pebble that would not stay put.",
      ...
      `set`: Set1, faction: fFreljord, number: 49'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fFreljord, number: 49'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 37'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 9'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fFreljord, number: 9'u8),
      Card(`set`: Set1, faction: fFreljord, number: 9'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 26'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 30'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fFreljord, number: 13'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 19'u8): CardInfo(
      ...
      cost: 7, rarity: crEpic, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set1, faction: fFreljord, number: 41'u8): CardInfo(
      ...
      faction: fFreljord, number: 25'u8): CardInfo(name: "Poro Herder",
      `type`: ctUnit,
      ...
      cost: 2, rarity: crRare, attack: 2, health: 3), Card(`set`: Set1,
      faction: fFreljord, number: 54'u8): CardInfo(name: "Scarmaiden Reaver",
      ...
      faction: fFreljord, number: 21'u8): CardInfo(name: "Tarkaz the Tribeless",
      ...
      Card(`set`: Set1, faction: fFreljord, number: 21'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 21'u8, subnumber: 1'u8): CardInfo(
      name: "Tarkaz\'s Fury", `type`: ctAbility,
      description: "Deal 1 to ALL battling units.",
      flavorText: "\"... Maybe not that gracefully after all.\" - Tryndamere",
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set1,
      faction: fFreljord, number: 43'u8): CardInfo(name: "Heart of the Fluft",
      ...
      Card(`set`: Set1, faction: fFreljord, number: 43'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 49'u8, subnumber: 1'u8): CardInfo(
      name: "Snow Hare", `type`: ctUnit, description: "", flavorText: "\"Wolf or hare, winter makes prey of us all.\"\n- Avarosan proverb",
      cost: 1, rarity: crNone, attack: 1, health: 1), Card(`set`: Set1,
      faction: fFreljord, number: 33'u8): CardInfo(name: "Wyrding Stones",
      `type`: ctUnit,
      ...
      faction: fFreljord, number: 11'u8): CardInfo(name: "Icevale Archer",
      ...
      faction: fFreljord, number: 50'u8): CardInfo(name: "Kindly Tavernkeeper",
      ...
      faction: fFreljord, number: 52'u8): CardInfo(name: "She Who Wanders",
      ...
      keywords: {Regeneration}, associatedCards: @[
      Card(`set`: Set1, faction: fFreljord, number: 52'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 52'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set1,
      faction: fFreljord, number: 16'u8): CardInfo(name: "Poro Snax",
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fFreljord, number: 5'u8): CardInfo(
      name: "Battle Fury", `type`: ctSpell, description: "Grant an ally +8|+4.",
      flavorText: "“I\'ve been told I have a... temper.” - Tryndamere",
      cost: 8, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fFreljord, number: 23'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 47'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 56'u8): CardInfo(
      name: "Icy Yeti", `type`: ctUnit, description: "When I\'m summoned, Frostbite enemies with 3 or less Health.",
      flavorText: "\"AaaaaaaAAaaaAaaaaah!\" - Bjerg the Wanderer", cost: 7,
      rarity: crRare, attack: 5, health: 5, subtypes: {csubYeti}), Card(
      `set`: Set1, faction: fFreljord, number: 27'u8): CardInfo(
      name: "Bull Elnuk", `type`: ctUnit, description: "", flavorText: "Avarosan folk tales speak of \"Old Uncle Elnuk\", a stubborn old grouch who wanted nothing more than a warm patch of grass and an argument to dig his heel into. ",
      cost: 4, rarity: crCommon, attack: 4, health: 5, subtypes: {csubElnuk}), Card(
      `set`: Set1, faction: fFreljord, number: 57'u8): CardInfo(
      ...
      cost: 7, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set1, faction: fFreljord, number: 4'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 46'u8): CardInfo(
      name: "Take Heart", `type`: ctSpell,
      description: "Grant a damaged ally +3|+3.", flavorText: "\"... Though his wounds were great, Braum threw back his head and laughed. For he knew that dire times are when heroes are made!\"\n- The Tale of Braum",
      cost: 3, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fFreljord, number: 12'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 40'u8): CardInfo(
      ...
      faction: fFreljord, number: 31'u8): CardInfo(name: "Ancient Yeti",
      ...
      keywords: {Overwhelm}), Card(`set`: Set1, faction: fFreljord,
                                   number: 36'u8, subnumber: 1'u8): CardInfo(
      name: "Bullseye", `type`: ctAbility, description: "Deal 1 to an enemy.",
      flavorText: "Gotcha.", cost: 0, rarity: crNone, keywords: {Skill}), Card(
      `set`: Set1, faction: fFreljord, number: 53'u8): CardInfo(
      ...
      cost: 4, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fFreljord, number: 1'u8): CardInfo(
      ...
      cost: 3, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set1, faction: fFreljord, number: 43'u8, subnumber: 1'u8): CardInfo(
      ...
      keywords: {LastBreath},
      associatedCards: @[Card(`set`: Set1, faction: fFreljord, number: 43'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 32'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 51'u8): CardInfo(
      name: "Tall Tales", `type`: ctSpell, description: "If you have a Yeti, summon an Enraged Yeti. Otherwise, create it on top of your deck.", flavorText: "\"... and this one has a mouth fulla big jagged teeths an\' smashy fists an super an-ger-y eyes an a HUUUGE TREE-SHAKING ROAR! Uncle Bjerg told me so!\" - Ingvar the Younger",
      cost: 3, rarity: crCommon, spellSpeed: some(ssSlow), keywords: {Slow},
      associatedCards: @[Card(`set`: Set1, faction: fFreljord, number: 28'u8)]), Card(
      `set`: Set1, faction: fFreljord, number: 34'u8): CardInfo(
      ...
      `set`: Set1, faction: fFreljord, number: 7'u8): CardInfo(
      ...
      faction: fFreljord, number: 3'u8): CardInfo(name: "Avarosan Sentry",
      ...
      `set`: Set1, faction: fShadowIsles, number: 38'u8): CardInfo(
      ...
      faction: fShadowIsles, number: 49'u8): CardInfo(name: "Glimpse Beyond",
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fShadowIsles, number: 53'u8): CardInfo(
      name: "Elise", `type`: ctUnit,
      description: "Attack: Summon an attacking Spiderling.", flavorText: "Once the head of a powerful Noxian house, Elise\'s dark ties to the Shadow Isles granted her unnatural youth and beauty in exchange for a few unwitting souls offered in sacrifice. An easy decision.",
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 53'u8, subnumber: 2'u8),
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 53'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 53'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 53'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 53'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 53'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 57'u8): CardInfo(
      name: "Ancient Crocolith", `type`: ctUnit,
      description: "To play me, kill 2 allies.", flavorText: "\"Put \'em in the cage, tum-te-dum... \nPluck up every soul, one by one...\nNever let ‘em go, no! No sir…\nElse them spirits make quite a stir...\"",
      cost: 4, rarity: crRare, attack: 7, health: 7), Card(`set`: Set1,
      faction: fShadowIsles, number: 23'u8): CardInfo(name: "Soul Shepherd",
      `type`: ctUnit,
      ...
      cost: 2, rarity: crCommon, attack: 2, health: 3), Card(`set`: Set1,
      faction: fShadowIsles, number: 10'u8): CardInfo(
      name: "Onslaught of Shadows", `type`: ctSpell,
      ...
      `set`: Set1, faction: fShadowIsles, number: 42'u8): CardInfo(
      name: "Hecarim", `type`: ctUnit,
      ...
      supertype: csupChampion, keywords: {Overwhelm}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 42'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 42'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 24'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 42'u8, subnumber: 1'u8): CardInfo(
      ...
      keywords: {Overwhelm}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 42'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 42'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 24'u8)]), Card(
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 42'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 24'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 27'u8): CardInfo(
      name: "Fresh Offerings", `type`: ctSpell,
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 27'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 27'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 48'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 18'u8): CardInfo(
      ...
      faction: fShadowIsles, number: 30'u8): CardInfo(name: "Kalista",
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 30'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 30'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 30'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 30'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 30'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 35'u8): CardInfo(
      name: "Rhasa the Sunderer", `type`: ctUnit, description: "Play: Kill the 2 Weakest enemies if an ally died this round.", flavorText: "\"We were told... they called it a legend\'s journey. We were going to... for Demacia\'s future. We sailed with such hope. But all... all those lives... for what?\" - Arie Wrence, Demacian soldier",
      cost: 8, rarity: crEpic, attack: 7, health: 5, keywords: {Fearsome}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 35'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 35'u8, subnumber: 1'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 2'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 24'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 5'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 37'u8): CardInfo(
      ...
      keywords: {Fearsome}), Card(`set`: Set1, faction: fShadowIsles,
                                  number: 48'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fShadowIsles, number: 52'u8): CardInfo(name: "Thresh",
      ...
      keywords: {Challenger}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 52'u8, subnumber: 1'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 52'u8, subnumber: 2'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 33'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 33'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 3'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 41'u8): CardInfo(
      ...
      faction: fShadowIsles, number: 45'u8): CardInfo(name: "Absorb Soul",
      `type`: ctSpell, description: "Drain 4 from an ally.",
      flavorText: "\"What kills you only makes me stronger.\" - Thresh",
      cost: 1, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fShadowIsles, number: 36'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, spellSpeed: some(ssSlow), keywords: {Slow}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 2'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 51'u8): CardInfo(
      ...
      cost: 5, rarity: crRare, attack: 4, health: 4), Card(`set`: Set1,
      faction: fShadowIsles, number: 12'u8): CardInfo(
      name: "Oblivious Islander", `type`: ctUnit, description: "Play: Grant an ally in hand Ephemeral and reduce its cost by 1.",
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 52'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 52'u8, subnumber: 1'u8): CardInfo(
      ...
      keywords: {Challenger}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 52'u8, subnumber: 2'u8),
      Card(`set`: Set1, faction: fShadowIsles, number: 52'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 31'u8): CardInfo(
      name: "Iron Harbinger", `type`: ctUnit,
      ...
      `set`: Set1, faction: fShadowIsles, number: 34'u8): CardInfo(
      name: "Black Spear", `type`: ctSpell,
      description: "If an ally died this round, deal 4 to a unit.",
      flavorText: "\"Our spear sings for the fallen.\" - Kalista", cost: 3,
      rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fShadowIsles, number: 43'u8): CardInfo(
      ...
      rarity: crCommon, attack: 1, health: 1, keywords: {LastBreath}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 2'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 9'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, attack: 3, health: 2), Card(`set`: Set1,
      faction: fShadowIsles, number: 7'u8): CardInfo(name: "Haunted Relic",
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssSlow), keywords: {Slow}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 7'u8, subnumber: 1'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 7'u8, subnumber: 1'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 56'u8): CardInfo(
      ...
      keywords: {Fearsome}), Card(`set`: Set1, faction: fShadowIsles,
                                  number: 1'u8): CardInfo(name: "Vengeance",
      `type`: ctSpell, description: "Kill a unit.", flavorText: "The betrayed invoke Kalista on their dying breath, hoping her spear brings them vengeance.",
      cost: 7, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fShadowIsles, number: 19'u8): CardInfo(
      name: "The Box", `type`: ctSpell,
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 33'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 28'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 25'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 50'u8): CardInfo(
      ...
      rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}, associatedCards: @[
      Card(`set`: Set1, faction: fShadowIsles, number: 2'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 16'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 21'u8): CardInfo(
      ...
      faction: fShadowIsles, number: 32'u8): CardInfo(
      name: "Chronicler of Ruin", `type`: ctUnit,
      description: "Play: Kill an ally, then revive it.", flavorText: "There was a time when she sat with her father--a lord curator--as he studied the dusty tomes. He hoped one day she would take on the mantle. But not like this.",
      cost: 4, rarity: crCommon, attack: 3, health: 3), Card(`set`: Set1,
      faction: fShadowIsles, number: 58'u8): CardInfo(name: "Ethereal Remitter",
      ...
      cost: 5, rarity: crRare, attack: 4, health: 3), Card(`set`: Set1,
      faction: fShadowIsles, number: 54'u8): CardInfo(
      name: "Grasp of the Undying", `type`: ctSpell,
      description: "Drain 3 from any unit.", flavorText: "The dead want nothing more than to silence the ceaseless pulse of the living.",
      cost: 5, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fShadowIsles, number: 44'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 39'u8): CardInfo(
      ...
      faction: fShadowIsles, number: 29'u8): CardInfo(name: "Withering Wail",
      ...
      rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fShadowIsles, number: 4'u8): CardInfo(
      ...
      faction: fShadowIsles, number: 26'u8): CardInfo(name: "Warden\'s Prey",
      ...
      cost: 1, rarity: crCommon, attack: 1, health: 1, keywords: {LastBreath}), Card(
      `set`: Set1, faction: fShadowIsles, number: 40'u8): CardInfo(
      ...
      Card(`set`: Set1, faction: fShadowIsles, number: 2'u8)]), Card(
      `set`: Set1, faction: fShadowIsles, number: 15'u8): CardInfo(
      ...
      cost: 9, rarity: crEpic, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set1, faction: fShadowIsles, number: 55'u8): CardInfo(
      ...
      `set`: Set1, faction: fShadowIsles, number: 47'u8): CardInfo(
      ...
      `set`: Set2, faction: fPiltoverZaun, number: 1'u8): CardInfo(
      ...
      `set`: Set2, faction: fPiltoverZaun, number: 10'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 6'u8): CardInfo(name: "Gotcha!",
      `type`: ctSpell,
      ...
      `set`: Set2, faction: fPiltoverZaun, number: 4'u8): CardInfo(
      ...
      rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fPiltoverZaun, number: 7'u8): CardInfo(
      ...
      faction: fPiltoverZaun, number: 2'u8): CardInfo(
      name: "Chief Mechanist Zevi", `type`: ctUnit, description: "When you draw a card, give it Fleeting and create an exact copy of it in hand.", flavorText: "At age five, she made the world\'s first multi-frequency sonic knife. While not very practical (she mostly used it to slice sandwiches), it set her on her way to the Wardens\' elite Armaments Department.",
      cost: 6, rarity: crEpic, attack: 5, health: 6), Card(`set`: Set2,
      faction: fPiltoverZaun, number: 8'u8): CardInfo(name: "Vi",
      `type`: ctUnit, description: "While I\'m in play or in hand, grant me +1|+0 when you play another card (max +8|+0). ", flavorText: "\"Enforcer Vi, please! Think of the people! The collateral damage! The PAPERWORK FOR INJURY CLAIMS!\" - Insightful Investigator",
      ...
      Card(`set`: Set2, faction: fPiltoverZaun, number: 8'u8, subnumber: 2'u8),
      Card(`set`: Set2, faction: fPiltoverZaun, number: 8'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fPiltoverZaun, number: 9'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fPiltoverZaun, number: 3'u8): CardInfo(
      ...
      cost: 4, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fPiltoverZaun, number: 8'u8, subnumber: 2'u8): CardInfo(
      ...
      keywords: {Burst}, associatedCards: @[
      Card(`set`: Set2, faction: fPiltoverZaun, number: 8'u8),
      Card(`set`: Set2, faction: fPiltoverZaun, number: 8'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fPiltoverZaun, number: 5'u8): CardInfo(
      ...
      faction: fBilgewater, number: 40'u8): CardInfo(name: "Shellshocker ",
      ...
      `set`: Set2, faction: fBilgewater, number: 57'u8): CardInfo(
      ...
      number: 41'u8): CardInfo(name: "The Beast Below", `type`: ctUnit,
      ...
      `set`: Set2, faction: fBilgewater, number: 13'u8): CardInfo(
      ...
      faction: fBilgewater, number: 56'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 56'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 56'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fBilgewater, number: 60'u8): CardInfo(name: "Crackshot Corsair",
      `type`: ctUnit,
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 60'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 11'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 30'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 30'u8, subnumber: 1'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 30'u8, subnumber: 4'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 30'u8, subnumber: 2'u8): CardInfo(
      ...
      faction: fBilgewater, number: 30'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 5, rarity: crNone, spellSpeed: some(ssSlow),
      subtypes: {csubTreasure}, keywords: {Slow}), Card(`set`: Set2,
      faction: fBilgewater, number: 30'u8, subnumber: 4'u8): CardInfo(
      ...
      keywords: {Fearsome, Deep}), Card(`set`: Set2, faction: fBilgewater,
                                        number: 30'u8, subnumber: 3'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 30'u8, subnumber: 4'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 19'u8): CardInfo(
      ...
      `set`: Set2, faction: fBilgewater, number: 55'u8): CardInfo(
      ...
      faction: fBilgewater, number: 17'u8): CardInfo(name: "Citrus Courier",
      `type`: ctUnit,
      ...
      faction: fBilgewater, number: 38'u8): CardInfo(name: "Zap Sprayfin",
      ...
      `set`: Set2, faction: fBilgewater, number: 21'u8): CardInfo(
      ...
      `set`: Set2, faction: fBilgewater, number: 35'u8): CardInfo(
      ...
      faction: fBilgewater, number: 58'u8): CardInfo(name: "Jagged Butcher",
      ...
      faction: fBilgewater, number: 28'u8): CardInfo(name: "Riptide Rex",
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 28'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 28'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set2,
      faction: fBilgewater, number: 37'u8): CardInfo(name: "Abyssal Eye",
      ...
      `set`: Set2, faction: fBilgewater, number: 8'u8): CardInfo(
      name: "Petty Officer", `type`: ctUnit,
      ...
      cost: 3, rarity: crNone, attack: 3, health: 1, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 47'u8): CardInfo(
      ...
      faction: fBilgewater, number: 4'u8): CardInfo(name: "Dreadway Deckhand",
      ...
      cost: 2, rarity: crCommon, attack: 2, health: 2, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 2'u8): CardInfo(
      ...
      cost: 9, rarity: crEpic, attack: 4, health: 8, keywords: {Fearsome}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 16'u8): CardInfo(
      name: "Slotbot", `type`: ctUnit, description: "Round Start: Grant me +0|+1 for each card you drew last round, then shuffle my stats.\c\n", flavorText: "One prototype spun three bombs and then exploded. Later models had this early \"feature\" removed.",
      cost: 3, rarity: crRare, attack: 1, health: 4), Card(`set`: Set2,
      faction: fBilgewater, number: 27'u8): CardInfo(name: "Hunting Fleet",
      ...
      cost: 4, rarity: crCommon, attack: 6, health: 6, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 36'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 50'u8): CardInfo(
      ...
      `set`: Set2, faction: fBilgewater, number: 15'u8): CardInfo(
      ...
      cost: 7, rarity: crEpic, attack: 3, health: 7, keywords: {Scout}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 22'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 10'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, attack: 1, health: 1, subtypes: {csubPoro}), Card(
      `set`: Set2, faction: fBilgewater, number: 9'u8): CardInfo(
      ...
      faction: fBilgewater, number: 5'u8): CardInfo(name: "Hired Gun",
      `type`: ctUnit,
      ...
      faction: fBilgewater, number: 39'u8): CardInfo(name: "Jaull Hunters",
      `type`: ctUnit,
      ...
      `set`: Set2, faction: fBilgewater, number: 6'u8): CardInfo(
      ...
      faction: fBilgewater, number: 36'u8): CardInfo(name: "Golden Narwhal",
      ...
      number: 33'u8): CardInfo(name: "Black Market Merchant", `type`: ctUnit, description: "When you draw an enemy card, reduce its cost by 1.\c\nPlunder: Nab 1.", flavorText: "\"If you want it, I\'ve got it! Even got some \'special stock\'.... Just remember, you didn\'t get it from me!\"",
                               cost: 2, rarity: crRare, attack: 2, health: 1), Card(
      `set`: Set2, faction: fBilgewater, number: 60'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set2,
      faction: fBilgewater, number: 32'u8): CardInfo(name: "Gangplank",
      ...
      supertype: csupChampion, keywords: {Overwhelm}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 2'u8),
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 3'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 3'u8): CardInfo(
      ...
      keywords: {Overwhelm}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 1'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 4'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 1'u8): CardInfo(
      ...
      number: 32'u8, subnumber: 4'u8): CardInfo(name: "Powderful Explosion",
      `type`: ctAbility,
      description: "Deal 1 to all enemies and the enemy Nexus.",
      flavorText: "\"Blow \'em to the depths!\" - Gangplank", cost: 0,
      rarity: crNone, keywords: {Skill}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 32'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 22'u8): CardInfo(
      ...
      supertype: csupChampion, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 22'u8, subnumber: 4'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 22'u8, subnumber: 3'u8),
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 22'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 22'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 22'u8, subnumber: 4'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 22'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 22'u8, subnumber: 3'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 22'u8, subnumber: 4'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set2,
      faction: fBilgewater, number: 22'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set2,
      faction: fBilgewater, number: 46'u8): CardInfo(name: "Fizz",
      `type`: ctUnit, description: "When you cast a spell, stop all enemy spells and skills targeting me and give me Elusive this round.", flavorText: "Of all Bilgewater\'s legendary figures, Fizz is the most mercurial. Some sailors curse him for the countless brutal wrecks littering the coast...",
      cost: 1, rarity: crChampion, attack: 2, health: 1,
      levelupDescription: "You\'ve cast 6+ spells.", supertype: csupChampion,
      keywords: {Imbue}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 46'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 46'u8, subnumber: 1'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 25'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 46'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 46'u8, subnumber: 3'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 25'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 46'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 46'u8, subnumber: 2'u8): CardInfo(
      ...
      spellSpeed: some(ssFast), supertype: csupChampion, keywords: {Fast}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 46'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 46'u8, subnumber: 3'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 26'u8): CardInfo(
      ...
      supertype: csupChampion, keywords: {QuickStrike}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 2'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 4'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 5'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 5'u8): CardInfo(
      ...
      faction: fBilgewater, number: 26'u8, subnumber: 3'u8): CardInfo(
      ...
      keywords: {QuickStrike}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 1'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 5'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 4'u8),
      ...
      keywords: {Burst}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 26'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 26'u8, subnumber: 2'u8): CardInfo(
      name: "Blue Card", `type`: ctAbility,
      description: "Refill 1 spell mana.\c\nDraw 1.",
      flavorText: "\"Blue as the Serpentine.\" - Twisted Fate", cost: 0,
      rarity: crNone, keywords: {Skill}), Card(`set`: Set2,
      faction: fBilgewater, number: 26'u8, subnumber: 4'u8): CardInfo(
      name: "Red Card", `type`: ctAbility,
      description: "Deal 1 to all enemies and the enemy Nexus.",
      flavorText: "\"Somethin\' for everyone.\" - Twisted Fate", cost: 0,
      rarity: crNone, keywords: {Skill}), Card(`set`: Set2,
      faction: fBilgewater, number: 53'u8): CardInfo(name: "Nautilus",
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 53'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 53'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fBilgewater, number: 53'u8),
      Card(`set`: Set2, faction: fBilgewater, number: 53'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fBilgewater, number: 61'u8): CardInfo(
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fBilgewater, number: 24'u8): CardInfo(
      ...
      cost: 3, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set2, faction: fBilgewater, number: 3'u8): CardInfo(
      ...
      `set`: Set2, faction: fBilgewater, number: 25'u8): CardInfo(
      ...
      `set`: Set2, faction: fBilgewater, number: 42'u8): CardInfo(
      ...
      cost: 7, rarity: crEpic, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set2, faction: fBilgewater, number: 59'u8): CardInfo(
      ...
      `set`: Set2, faction: fBilgewater, number: 23'u8): CardInfo(
      ...
      cost: 3, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fBilgewater, number: 31'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set2, faction: fBilgewater, number: 63'u8): CardInfo(
      ...
      cost: 3, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set2, faction: fBilgewater, number: 45'u8): CardInfo(
      ...
      rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set2, faction: fBilgewater, number: 20'u8): CardInfo(
      ...
      `set`: Set2, faction: fBilgewater, number: 44'u8): CardInfo(
      name: "Jettison", `type`: ctSpell, description: "Toss 4.", flavorText: "\"If it ain\'t worth its weight, it goes over. Same goes for you lot, \'n all. Now back ta work!\" - Petty Officer",
      cost: 1, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fBilgewater, number: 62'u8): CardInfo(
      ...
      `set`: Set2, faction: fFreljord, number: 9'u8): CardInfo(
      name: "Wolfrider", `type`: ctUnit,
      description: "Plunder: Get an empty mana gem.", flavorText: "The young riders of the Winter\'s Claw are given a wolf pup the moment they can hold a weapon. Their upbringing is devoted entirely to battle--the wolf trained to savage and maim, and the rider to pillage and steal.",
      cost: 4, rarity: crCommon, attack: 4, health: 3, keywords: {Overwhelm}), Card(
      `set`: Set2, faction: fFreljord, number: 4'u8): CardInfo(
      ...
      `set`: Set2, faction: fFreljord, number: 2'u8): CardInfo(name: "Sejuani",
      `type`: ctUnit,
      ...
      supertype: csupChampion, keywords: {Overwhelm}, associatedCards: @[
      Card(`set`: Set2, faction: fFreljord, number: 2'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fFreljord, number: 2'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fFreljord, number: 1'u8): CardInfo(
      ...
      faction: fFreljord, number: 5'u8): CardInfo(name: "Ursine Spiritwalker",
      `type`: ctUnit,
      ...
      Card(`set`: Set2, faction: fFreljord, number: 5'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fFreljord, number: 5'u8, subnumber: 1'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set2, faction: fFreljord, number: 5'u8)]), Card(
      `set`: Set2, faction: fFreljord, number: 10'u8): CardInfo(
      ...
      rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fFreljord, number: 8'u8): CardInfo(
      ...
      keywords: {Burst}, associatedCards: @[
      Card(`set`: Set2, faction: fFreljord, number: 2'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fFreljord, number: 2'u8)]), Card(`set`: Set2,
      faction: fFreljord, number: 2'u8, subnumber: 3'u8): CardInfo(
      name: "Sejuani", `type`: ctUnit, description: "Play: Give an enemy Frostbite and Vulnerable this round.\c\nEach round, the first time you damage the enemy Nexus, Frostbite all enemies.", flavorText: "\"Lay them low! Show them the Freljord belongs to the Winter\'s Claw!\"",
      cost: 6, rarity: crNone, attack: 6, health: 7, supertype: csupChampion,
      keywords: {Overwhelm}, associatedCards: @[
      Card(`set`: Set2, faction: fFreljord, number: 2'u8),
      Card(`set`: Set2, faction: fFreljord, number: 2'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fFreljord, number: 7'u8): CardInfo(
      name: "Fury of the North", `type`: ctSpell,
      description: "Give an ally +3|+4 this round.",
      flavorText: "\"Embrace the beast within!\" - Sejuani", cost: 4,
      rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fFreljord, number: 6'u8): CardInfo(
      ...
      number: 3'u8): CardInfo(name: "Aurora Porealis", `type`: ctSpell, description: "Create 2 random Poros and 2 Poro Snax in hand.", flavorText: "\"When you wish upon a poro,\nAn\' look at da night sky,\nYou\'ll see da snax among da stars,\nAll sparkly in our eyes\" - Ingvar the Younger",
                              cost: 6, rarity: crEpic,
                              spellSpeed: some(ssBurst), keywords: {Burst}, associatedCards: @[
      Card(`set`: Set1, faction: fFreljord, number: 16'u8)]), Card(`set`: Set2,
      faction: fNoxus, number: 1'u8): CardInfo(name: "The Leviathan",
      ...
      associatedCards: @[Card(`set`: Set2, faction: fNoxus, number: 7'u8)]), Card(
      `set`: Set2, faction: fNoxus, number: 7'u8): CardInfo(name: "Swain",
      ...
      Card(`set`: Set2, faction: fNoxus, number: 7'u8, subnumber: 2'u8),
      Card(`set`: Set2, faction: fNoxus, number: 7'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fNoxus, number: 7'u8, subnumber: 2'u8): CardInfo(
      ...
      supertype: csupChampion, keywords: {Fast}, associatedCards: @[
      Card(`set`: Set2, faction: fNoxus, number: 7'u8),
      Card(`set`: Set2, faction: fNoxus, number: 7'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fNoxus, number: 6'u8): CardInfo(name: "Citybreaker",
      ...
      faction: fNoxus, number: 2'u8): CardInfo(name: "Aurok Glinthorn ",
      ...
      faction: fNoxus, number: 9'u8): CardInfo(name: "Ravenous Flock",
      `type`: ctSpell,
      ...
      `set`: Set2, faction: fNoxus, number: 4'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fNoxus, number: 4'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fNoxus, number: 3'u8): CardInfo(
      name: "Noxian Fervor", `type`: ctSpell,
      description: "Deal 3 to an ally to deal 3 to anything.",
      flavorText: "\"Sacrifices must be made.\" - Jericho Swain", cost: 3,
      rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set2, faction: fNoxus, number: 10'u8): CardInfo(
      ...
      `set`: Set2, faction: fNoxus, number: 4'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set2,
      faction: fNoxus, number: 8'u8): CardInfo(name: "Death\'s Hand",
      `type`: ctSpell,
      description: "Deal 2 to an enemy and 1 to the enemy Nexus.",
      flavorText: "\"Try to die with dignity.\" - Swain", cost: 3,
      rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set2, faction: fNoxus, number: 5'u8): CardInfo(
      name: "Iron Ballista", `type`: ctUnit, description: "", flavorText: "\"A siege is easy, if you\'ve the tools. The \'breakers bring \'em out, and the ballistae bring \'em down.\" - Siege Engineer",
      cost: 3, rarity: crCommon, attack: 4, health: 3, keywords: {Overwhelm}), Card(
      `set`: Set2, faction: fDemacia, number: 3'u8): CardInfo(
      ...
      faction: fDemacia, number: 8'u8): CardInfo(name: "Greathorn Companion",
      ...
      `set`: Set2, faction: fDemacia, number: 4'u8): CardInfo(
      ...
      keywords: {Barrier, Scout}), Card(`set`: Set2, faction: fDemacia,
                                        number: 6'u8): CardInfo(name: "Quinn",
      ...
      Card(`set`: Set2, faction: fDemacia, number: 6'u8, subnumber: 2'u8),
      Card(`set`: Set2, faction: fDemacia, number: 6'u8, subnumber: 1'u8),
      ...
      cost: 2, rarity: crNone, spellSpeed: some(ssSlow),
      supertype: csupChampion, keywords: {Slow}, associatedCards: @[
      Card(`set`: Set2, faction: fDemacia, number: 6'u8),
      Card(`set`: Set2, faction: fDemacia, number: 6'u8, subnumber: 1'u8),
      Card(`set`: Set2, faction: fDemacia, number: 6'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fDemacia, number: 6'u8, subnumber: 2'u8): CardInfo(
      ...
      number: 6'u8, subnumber: 1'u8): CardInfo(name: "Quinn", `type`: ctUnit,
      ...
      Card(`set`: Set2, faction: fDemacia, number: 6'u8),
      Card(`set`: Set2, faction: fDemacia, number: 6'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fDemacia, number: 6'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fDemacia, number: 9'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set2, faction: fDemacia, number: 3'u8)]), Card(
      `set`: Set2, faction: fDemacia, number: 5'u8): CardInfo(
      ...
      `set`: Set2, faction: fDemacia, number: 2'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fDemacia, number: 6'u8, subnumber: 2'u8)]), Card(
      `set`: Set2, faction: fDemacia, number: 10'u8): CardInfo(
      ...
      number: 7'u8): CardInfo(name: "Ranger\'s Resolve", `type`: ctSpell,
                              ...
                              cost: 1, rarity: crRare,
                              spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fDemacia, number: 1'u8): CardInfo(
      name: "Concerted Strike", `type`: ctSpell,
      description: "Pick an enemy. 2 allies strike it.",
      flavorText: "\"With me, as one!\" - Greenfang Warden", cost: 5,
      rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set2, faction: fShadowIsles, number: 5'u8): CardInfo(
      name: "Sap Magic", `type`: ctSpell,
      description: "Toss 3.\c\nHeal all allies 3.",
      flavorText: "\"These Isles will be cleansed.\" - Maokai", cost: 3,
      rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set2, faction: fShadowIsles, number: 10'u8): CardInfo(
      ...
      `set`: Set2, faction: fShadowIsles, number: 8'u8): CardInfo(
      name: "Maokai", `type`: ctUnit, description: "Each round, the first time you play another ally, Toss 2 and summon a Sapling.", flavorText: "These cursed lands would not break Maokai. The treant\'s commitment ran too deep, and his fury burned too bright, for anything to stand in his way.",
      ...
      supertype: csupChampion, associatedCards: @[
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 1'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 2'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 3'u8)]), Card(
      `set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 3'u8): CardInfo(
      ...
      rarity: crNone, spellSpeed: some(ssBurst), supertype: csupChampion,
      keywords: {Burst}, associatedCards: @[
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 2'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8)]), Card(
      `set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 2'u8): CardInfo(
      name: "Maokai", `type`: ctUnit, description: "When I Level Up, Obliterate the enemy deck, leaving 4 non-champions.\c\nRound Start: Summon a Sapling.", flavorText: "He would destroy the blight within these isles, and restore its long-lost life.",
      cost: 4, rarity: crNone, attack: 2, health: 5, supertype: csupChampion,
      keywords: {Regeneration}, associatedCards: @[
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 1'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 3'u8)]), Card(
      `set`: Set2, faction: fShadowIsles, number: 7'u8): CardInfo(
      ...
      `set`: Set2, faction: fShadowIsles, number: 3'u8): CardInfo(
      ...
      keywords: {Deep}), Card(`set`: Set2, faction: fShadowIsles, number: 1'u8): CardInfo(
      ...
      faction: fShadowIsles, number: 2'u8): CardInfo(name: "Overgrown Snapvine",
      ...
      Card(`set`: Set2, faction: fShadowIsles, number: 2'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 2'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 2'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 2'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 2'u8),
      ...
      Card(`set`: Set2, faction: fShadowIsles, number: 2'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 2'u8),
      Card(`set`: Set2, faction: fShadowIsles, number: 2'u8)]), Card(
      `set`: Set2, faction: fShadowIsles, number: 4'u8): CardInfo(
      name: "Blighted Caretaker", `type`: ctUnit,
      ...
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 3'u8)]), Card(
      `set`: Set2, faction: fShadowIsles, number: 6'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, attack: 1, health: 1), Card(`set`: Set2,
      faction: fShadowIsles, number: 9'u8): CardInfo(name: "Sapling Toss",
      `type`: ctSpell, description: "Summon a Sapling at the next Round Start.",
      flavorText: "\"Wheeeeeeee!\" - Sapling", cost: 1, rarity: crCommon,
      spellSpeed: some(ssBurst), keywords: {Burst}, associatedCards: @[
      Card(`set`: Set2, faction: fShadowIsles, number: 8'u8, subnumber: 3'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 8'u8): CardInfo(name: "Sonic Wave",
      ...
      spellSpeed: some(ssBurst), keywords: {Burst}, associatedCards: @[
      Card(`set`: Set2, faction: fIonia, number: 8'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 8'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fIonia, number: 5'u8, subnumber: 1'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set2, faction: fIonia, number: 5'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 2'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fIonia, number: 2'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 2'u8, subnumber: 1'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set2, faction: fIonia, number: 2'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 6'u8): CardInfo(name: "Lee Sin",
      ...
      keywords: {Imbue}, associatedCards: @[
      Card(`set`: Set2, faction: fIonia, number: 8'u8, subnumber: 1'u8),
      Card(`set`: Set2, faction: fIonia, number: 11'u8),
      ...
      Card(`set`: Set2, faction: fIonia, number: 6'u8),
      Card(`set`: Set2, faction: fIonia, number: 8'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 6'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fIonia, number: 11'u8),
      Card(`set`: Set2, faction: fIonia, number: 6'u8, subnumber: 3'u8),
      Card(`set`: Set2, faction: fIonia, number: 6'u8)]), Card(`set`: Set2,
      faction: fIonia, number: 6'u8, subnumber: 3'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set2,
      faction: fIonia, number: 4'u8): CardInfo(name: "Horns of the Dragon",
      ...
      `set`: Set2, faction: fIonia, number: 3'u8): CardInfo(
      ...
      Card(`set`: Set2, faction: fIonia, number: 3'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 1'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, attack: 3, health: 2), Card(`set`: Set2,
      faction: fIonia, number: 3'u8, subnumber: 1'u8): CardInfo(
      name: "Dragonling", `type`: ctUnit, description: "", flavorText: "\"The spirit gives to those who listen.\" - Eye of the Dragon",
      cost: 2, rarity: crNone, attack: 2, health: 1, subtypes: {csubDragon},
      keywords: {Ephemeral, Lifesteal}), Card(`set`: Set2, faction: fIonia,
      number: 5'u8): CardInfo(name: "Concussive Palm", `type`: ctSpell, description: "Stun an enemy to summon a Tail of the Dragon.", flavorText: "\"You did not see me leave, nor will you see me return.\" - Tail of the Dragon",
                              cost: 4, rarity: crRare, spellSpeed: some(ssFast),
                              keywords: {Fast}, associatedCards: @[
      Card(`set`: Set2, faction: fIonia, number: 5'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 10'u8): CardInfo(name: "Retreat",
      `type`: ctSpell,
      ...
      Card(`set`: Set2, faction: fIonia, number: 10'u8, subnumber: 1'u8)]), Card(
      `set`: Set2, faction: fIonia, number: 7'u8): CardInfo(
      name: "Dragon\'s Rage", `type`: ctSpell, description: "An ally kicks an enemy into the enemy Nexus, striking both.\c\nIf the enemy survives, Recall it.", flavorText: "\"The Dragon must be unleashed, or it will consume me from within.\" - Lee Sin",
      cost: 7, rarity: crEpic, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set2, faction: fIonia, number: 10'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 1, rarity: crNone, spellSpeed: some(ssBurst),
      keywords: {Burst, Fleeting}), Card(`set`: Set2, faction: fIonia,
      ...
      Card(`set`: Set3, faction: fBilgewater, number: 6'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fBilgewater, number: 10'u8): CardInfo(
      ...
      supertype: csupChampion, associatedCards: @[
      Card(`set`: Set3, faction: fBilgewater, number: 4'u8, subnumber: 4'u8),
      Card(`set`: Set3, faction: fBilgewater, number: 4'u8, subnumber: 3'u8),
      Card(`set`: Set3, faction: fBilgewater, number: 4'u8, subnumber: 2'u8)]), Card(
      `set`: Set3, faction: fBilgewater, number: 4'u8, subnumber: 2'u8): CardInfo(
      ...
      Card(`set`: Set3, faction: fBilgewater, number: 4'u8, subnumber: 3'u8),
      Card(`set`: Set3, faction: fBilgewater, number: 4'u8)]), Card(`set`: Set3,
      faction: fBilgewater, number: 4'u8, subnumber: 3'u8): CardInfo(
      ...
      supertype: csupChampion, keywords: {Slow}, associatedCards: @[
      Card(`set`: Set3, faction: fBilgewater, number: 4'u8),
      Card(`set`: Set3, faction: fBilgewater, number: 4'u8, subnumber: 3'u8)]), Card(
      `set`: Set3, faction: fBilgewater, number: 2'u8): CardInfo(
      ...
      `set`: Set3, faction: fBilgewater, number: 14'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssSlow), keywords: {Slow}, associatedCards: @[
      Card(`set`: Set2, faction: fBilgewater, number: 34'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fBilgewater, number: 7'u8): CardInfo(
      name: "Boxtopus", `type`: ctUnit, description: "Play: Deal 3 to me.", flavorText: "\"Sure, Pablo might be in a bit of a \'dry patch\'--heh--and, yeah, he\'s taken his fair share of punches... but ya know what? Ain\'t nobody else around here getting octokills, pal.\" - Wise Fry",
      cost: 2, rarity: crCommon, attack: 3, health: 4, keywords: {Challenger}), Card(
      `set`: Set3, faction: fBilgewater, number: 6'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fBilgewater, number: 3'u8): CardInfo(name: "Wise Fry",
      ...
      keywords: {Elusive}), Card(`set`: Set3, faction: fTargon, number: 4'u8): CardInfo(
      ...
      faction: fTargon, number: 37'u8): CardInfo(name: "The Scourge",
      ...
      faction: fTargon, number: 59'u8): CardInfo(name: "The Golden Sister",
      `type`: ctUnit,
      ...
      Card(`set`: Set3, faction: fTargon, number: 59'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 53'u8): CardInfo(name: "Moonglow",
      ...
      faction: fTargon, number: 32'u8): CardInfo(name: "Written in Stars",
      `type`: ctSpell,
      ...
      cost: 4, rarity: crNone, spellSpeed: some(ssBurst),
      subtypes: {csubCelestial}, keywords: {Burst}), Card(`set`: Set3,
      faction: fTargon, number: 24'u8): CardInfo(name: "Supernova",
      ...
      subtypes: {csubCelestial}, keywords: {Slow}), Card(`set`: Set3,
      faction: fTargon, number: 66'u8): CardInfo(name: "Cosmic Inspiration",
      ...
      subtypes: {csubCelestial}, keywords: {Slow}), Card(`set`: Set3,
      faction: fTargon, number: 77'u8): CardInfo(name: "Living Legends",
      ...
      subtypes: {csubCelestial}, keywords: {Burst}), Card(`set`: Set3,
      faction: fTargon, number: 10'u8): CardInfo(name: "The Destroyer",
      ...
      number: 70'u8): CardInfo(name: "The Traveler", `type`: ctUnit,
      ...
      faction: fTargon, number: 49'u8): CardInfo(name: "Meteor Shower",
      ...
      cost: 5, rarity: crNone, spellSpeed: some(ssSlow),
      subtypes: {csubCelestial}, keywords: {Slow}), Card(`set`: Set3,
      faction: fTargon, number: 43'u8): CardInfo(name: "Falling Comet",
      ...
      subtypes: {csubCelestial}, keywords: {Slow}), Card(`set`: Set3,
      faction: fTargon, number: 22'u8): CardInfo(name: "The Great Beyond",
      ...
      faction: fTargon, number: 78'u8): CardInfo(name: "Cosmic Rays",
      ...
      subtypes: {csubCelestial}, keywords: {Slow}), Card(`set`: Set3,
      faction: fTargon, number: 65'u8): CardInfo(name: "Equinox",
      `type`: ctSpell, description: "Silence a follower.",
      flavorText: "In the space between the stars, there is absolute silence.",
      cost: 1, rarity: crNone, spellSpeed: some(ssSlow),
      subtypes: {csubCelestial}, keywords: {Slow}), Card(`set`: Set3,
      faction: fTargon, number: 50'u8): CardInfo(name: "The Warrior",
      ...
      keywords: {Challenger}), Card(`set`: Set3, faction: fTargon, number: 11'u8): CardInfo(
      name: "Crescent Strike", `type`: ctSpell, description: "Stun 2 enemies.",
      flavorText: "\"Even the moon\'s glow can be blinding.\" - Diana\n\n",
      cost: 3, rarity: crNone, spellSpeed: some(ssSlow),
      subtypes: {csubCelestial}, keywords: {Slow}), Card(`set`: Set3,
      faction: fTargon, number: 95'u8): CardInfo(name: "The Trickster",
      ...
      keywords: {Elusive}), Card(`set`: Set3, faction: fTargon, number: 59'u8,
      ...
      cost: 6, rarity: crNone, attack: 4, health: 3, subtypes: {csubCelestial},
      keywords: {Elusive},
      associatedCards: @[Card(`set`: Set3, faction: fTargon, number: 59'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 90'u8): CardInfo(
      name: "The Charger", `type`: ctUnit, description: "", flavorText: "\"The gold of the sun adorns his horns, and its fire lights his heart. Let the thunder of our shields ring out like the thunder of his hooves across the horizon!\" - Solari battle prayer",
      cost: 1, rarity: crNone, attack: 4, health: 1, subtypes: {csubCelestial},
      keywords: {Overwhelm}), Card(`set`: Set3, faction: fTargon, number: 73'u8): CardInfo(
      ...
      cost: 1, rarity: crCommon, attack: 2, health: 1, associatedCards: @[
      Card(`set`: Set3, faction: fTargon, number: 73'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 73'u8, subnumber: 1'u8): CardInfo(
      ...
      `set`: Set3, faction: fTargon, number: 1'u8): CardInfo(
      ...
      Card(`set`: Set3, faction: fTargon, number: 1'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 60'u8): CardInfo(
      ...
      faction: fTargon, number: 33'u8): CardInfo(name: "Grandfather Rumul",
      ...
      Card(`set`: Set3, faction: fTargon, number: 56'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 56'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set3, faction: fTargon, number: 56'u8, subnumber: 1'u8),
      Card(`set`: Set3, faction: fTargon, number: 56'u8)]), Card(`set`: Set3,
      faction: fTargon, number: 67'u8): CardInfo(name: "Crystal Ibex",
      ...
      faction: fTargon, number: 92'u8): CardInfo(name: "Mountain Goat",
      ...
      `set`: Set3, faction: fTargon, number: 55'u8): CardInfo(name: "Soraka",
      ...
      Card(`set`: Set3, faction: fTargon, number: 55'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 55'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set3, faction: fTargon, number: 55'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 48'u8): CardInfo(
      name: "Gift Giver", `type`: ctUnit,
      description: "When I\'m summoned, create a Gem in hand.", flavorText: "\"They say the Protector blessed these gems. Wear them, and he shall be with you in spirit.\"",
      cost: 1, rarity: crCommon, attack: 1, health: 2, associatedCards: @[
      Card(`set`: Set3, faction: fTargon, number: 92'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 63'u8): CardInfo(
      name: "Moondreamer", `type`: ctUnit, description: "Play: Invoke.", flavorText: "\"Look at all our friends out in the sky tonight! See that extra bright star? That\'s the Messenger\'s eye staring down at us! That dim cluster way out there? It is the Trickster hiding behind clouds! And that one over--KULUN, SHH! You cannot paw those down...!\"",
      cost: 5, rarity: crCommon, attack: 3, health: 5), Card(`set`: Set3,
      faction: fTargon, number: 6'u8): CardInfo(name: "Inviolus Vox",
      ...
      keywords: {Fury}), Card(`set`: Set3, faction: fTargon, number: 54'u8): CardInfo(
      ...
      supertype: csupChampion, associatedCards: @[
      Card(`set`: Set3, faction: fTargon, number: 54'u8, subnumber: 3'u8),
      ...
      Card(`set`: Set3, faction: fTargon, number: 54'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 54'u8, subnumber: 3'u8): CardInfo(
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set3,
      faction: fTargon, number: 54'u8, subnumber: 1'u8): CardInfo(name: "Leona",
      ...
      Card(`set`: Set3, faction: fTargon, number: 54'u8, subnumber: 3'u8),
      Card(`set`: Set3, faction: fTargon, number: 54'u8, subnumber: 2'u8),
      Card(`set`: Set3, faction: fTargon, number: 54'u8)]), Card(`set`: Set3,
      faction: fTargon, number: 14'u8): CardInfo(name: "Herald of Dragons",
      ...
      cost: 0, rarity: crNone, keywords: {Skill}), Card(`set`: Set3,
      faction: fTargon, number: 75'u8): CardInfo(name: "Lunari Priestess",
      ...
      faction: fTargon, number: 20'u8): CardInfo(name: "Resplendent Stellacorn",
      ...
      faction: fTargon, number: 71'u8): CardInfo(name: "Tyari the Traveler",
      ...
      faction: fTargon, number: 87'u8): CardInfo(name: "Aurelion Sol",
      ...
      Card(`set`: Set3, faction: fTargon, number: 87'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 87'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set3, faction: fTargon, number: 87'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 19'u8): CardInfo(name: "Bastion",
      ...
      faction: fTargon, number: 45'u8): CardInfo(name: "Astral Protection",
      ...
      cost: 4, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 80'u8): CardInfo(
      ...
      cost: 3, rarity: crCommon, attack: 3, health: 3, associatedCards: @[
      Card(`set`: Set3, faction: fTargon, number: 80'u8, subnumber: 1'u8)]), Card(
      ...
      `set`: Set3, faction: fTargon, number: 41'u8): CardInfo(
      ...
      Card(`set`: Set3, faction: fTargon, number: 92'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 28'u8): CardInfo(
      ...
      faction: fTargon, number: 72'u8): CardInfo(name: "Fused Firebrand",
      ...
      number: 25'u8): CardInfo(name: "Shards of the Mountain", `type`: ctSpell,
      ...
      rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 12'u8): CardInfo(
      ...
      `set`: Set3, faction: fTargon, number: 94'u8): CardInfo(
      ...
      cost: 2, rarity: crCommon, attack: 2, health: 3), Card(`set`: Set3,
      faction: fTargon, number: 76'u8): CardInfo(name: "Mountain Scryer",
      `type`: ctUnit,
      ...
      faction: fTargon, number: 100'u8): CardInfo(name: "Eclipse Dragon",
      ...
      keywords: {Fury}), Card(`set`: Set3, faction: fTargon, number: 58'u8,
                              subnumber: 1'u8): CardInfo(name: "Taric",
      ...
      rarity: crNone, spellSpeed: some(ssBurst), supertype: csupChampion,
      keywords: {Burst}, associatedCards: @[
      Card(`set`: Set3, faction: fTargon, number: 58'u8),
      Card(`set`: Set3, faction: fTargon, number: 58'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fTargon, number: 29'u8): CardInfo(
      ...
      faction: fTargon, number: 92'u8, subnumber: 1'u8): CardInfo(name: "Gem",
      ...
      cost: 1, rarity: crNone, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 62'u8): CardInfo(
      ...
      faction: fTargon, number: 82'u8): CardInfo(name: "Morning Light",
      ...
      cost: 5, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set3, faction: fTargon, number: 47'u8): CardInfo(
      ...
      faction: fTargon, number: 38'u8): CardInfo(name: "Whiteflame Protector",
      ...
      keywords: {Fury}), Card(`set`: Set3, faction: fTargon, number: 81'u8): CardInfo(
      ...
      faction: fTargon, number: 7'u8): CardInfo(name: "Fledgling Stellacorn",
      ...
      cost: 3, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 30'u8): CardInfo(name: "Stargazer",
      `type`: ctUnit,
      ...
      faction: fTargon, number: 88'u8): CardInfo(name: "Solari Soldier",
      ...
      faction: fTargon, number: 89'u8): CardInfo(name: "Crescent Guardian",
      ...
      `set`: Set3, faction: fTargon, number: 27'u8): CardInfo(
      name: "Zenith Blade", `type`: ctSpell, description: "Grant an ally +1|+2 and Overwhelm.\c\nDaybreak: Draw a Zenith Blade.", flavorText: "\"Let the sun imbue you with Her strength!\" - Solari Priest",
      cost: 3, rarity: crCommon, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set3, faction: fTargon, number: 84'u8): CardInfo(
      name: "Starshaping", `type`: ctSpell, description: "Invoke a Celestial card that costs 7 or more, then heal an ally or your Nexus 5.", flavorText: "\"Look to the stars. If you\'re lucky, I\'ll look back.\" - Aurelion Sol",
      cost: 5, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 3'u8, subnumber: 1'u8): CardInfo(
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 3'u8, subnumber: 2'u8): CardInfo(
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 36'u8): CardInfo(
      name: "Blessing of Targon", `type`: ctSpell,
      description: "Grant an ally +3|+3.",
      flavorText: "\"A little something from Targon.\" - Taric", cost: 5,
      rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 39'u8): CardInfo(name: "Porofly",
      `type`: ctUnit, description: "",
      ...
      `type`: ctSpell, description: "Grant an ally Challenger.",
      flavorText: "\"None shall escape us!\" - Shyvana", cost: 3,
      rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fDemacia, number: 15'u8): CardInfo(
      ...
      faction: fDemacia, number: 6'u8): CardInfo(name: "Screeching Dragon",
      ...
      number: 2'u8): CardInfo(name: "Strafing Strike", `type`: ctSpell, description: "An ally and an enemy strike each other. Then, if the ally is a Dragon, heal it 2.", flavorText: "When knight and dragon separated, panting and wounded, the latter seemed reinvigorated. It smelled blood, and was eager for more.",
                              cost: 3, rarity: crRare, spellSpeed: some(ssFast),
                              keywords: {Fast}), Card(`set`: Set3,
      faction: fDemacia, number: 11'u8): CardInfo(name: "Shyvana",
      ...
      Card(`set`: Set3, faction: fDemacia, number: 2'u8),
      Card(`set`: Set3, faction: fDemacia, number: 11'u8, subnumber: 2'u8),
      Card(`set`: Set3, faction: fDemacia, number: 11'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fDemacia, number: 11'u8, subnumber: 1'u8): CardInfo(
      ...
      rarity: crNone, spellSpeed: some(ssBurst), supertype: csupChampion,
      keywords: {Burst}, associatedCards: @[
      Card(`set`: Set3, faction: fDemacia, number: 11'u8),
      Card(`set`: Set3, faction: fDemacia, number: 11'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fDemacia, number: 3'u8): CardInfo(
      ...
      faction: fDemacia, number: 13'u8): CardInfo(name: "Stalking Broodmother",
      ...
      keywords: {Fury, Scout}), Card(`set`: Set3, faction: fDemacia,
                                     number: 5'u8): CardInfo(
      ...
      faction: fDemacia, number: 7'u8): CardInfo(name: "Kadregrin the Infernal",
      ...
      keywords: {Fury}), Card(`set`: Set3, faction: fDemacia, number: 12'u8): CardInfo(
      ...
      associatedCards: @[Card(`set`: Set1, faction: fDemacia, number: 16'u8)]), Card(
      `set`: Set3, faction: fDemacia, number: 14'u8): CardInfo(
      name: "Sharpsight", `type`: ctSpell, description: "Give an ally +2|+2 and \"I can block units with Elusive\" this round.", flavorText: "Any who would dare breach Demacia\'s walls will find a full company awaiting them--forewarned and heavily armed.",
      cost: 2, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fIonia, number: 17'u8): CardInfo(name: "Pix!",
      `type`: ctUnit,
      ...
      faction: fIonia, number: 8'u8): CardInfo(name: "Whimsy!", `type`: ctSpell, description: "Transform a follower into a 1|1 Squirrel and Silence it this round.",
      flavorText: "\"Adoribus!\" - Lulu", cost: 4, rarity: crCommon,
      spellSpeed: some(ssBurst), keywords: {Burst}, associatedCards: @[
      Card(`set`: Set3, faction: fIonia, number: 8'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fIonia, number: 8'u8, subnumber: 1'u8): CardInfo(
      ...
      faction: fIonia, number: 1'u8): CardInfo(name: "Flower Child",
      ...
      faction: fIonia, number: 19'u8): CardInfo(name: "Singular Will",
      `type`: ctSpell,
      ...
      `set`: Set3, faction: fIonia, number: 2'u8): CardInfo(name: "Lulu",
      `type`: ctUnit,
      ...
      supertype: csupChampion, associatedCards: @[
      Card(`set`: Set3, faction: fIonia, number: 2'u8, subnumber: 1'u8),
      Card(`set`: Set3, faction: fIonia, number: 2'u8, subnumber: 5'u8),
      Card(`set`: Set3, faction: fIonia, number: 8'u8, subnumber: 1'u8),
      Card(`set`: Set3, faction: fIonia, number: 2'u8, subnumber: 4'u8)]), Card(
      `set`: Set3, faction: fIonia, number: 2'u8, subnumber: 4'u8): CardInfo(
      ...
      spellSpeed: some(ssBurst), supertype: csupChampion, keywords: {Burst}, associatedCards: @[
      Card(`set`: Set3, faction: fIonia, number: 8'u8, subnumber: 1'u8),
      Card(`set`: Set3, faction: fIonia, number: 2'u8),
      Card(`set`: Set3, faction: fIonia, number: 2'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fIonia, number: 2'u8, subnumber: 1'u8): CardInfo(
      ...
      Card(`set`: Set3, faction: fIonia, number: 8'u8, subnumber: 1'u8),
      Card(`set`: Set3, faction: fIonia, number: 2'u8, subnumber: 4'u8)]), Card(
      `set`: Set3, faction: fIonia, number: 11'u8): CardInfo(
      ...
      cost: 4, rarity: crRare, attack: 3, health: 4), Card(`set`: Set3,
      faction: fIonia, number: 9'u8): CardInfo(name: "Tasty Faefolk",
      ...
      `set`: Set3, faction: fIonia, number: 3'u8): CardInfo(name: "Fae Guide",
      ...
      faction: fIonia, number: 7'u8): CardInfo(name: "Trevor Snoozebottom",
      ...
      Card(`set`: Set3, faction: fIonia, number: 7'u8, subnumber: 1'u8)]), Card(
      `set`: Set3, faction: fIonia, number: 7'u8, subnumber: 1'u8): CardInfo(
      ...
      `set`: Set3, faction: fIonia, number: 22'u8): CardInfo(name: "Go Get It",
      ...
      cost: 2, rarity: crCommon, attack: 1, health: 3), Card(`set`: Set3,
      faction: fFreljord, number: 4'u8): CardInfo(name: "Revitalizing Roar",
      ...
      cost: 7, rarity: crRare, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set3, faction: fFreljord, number: 17'u8): CardInfo(
      ...
      faction: fFreljord, number: 6'u8): CardInfo(name: "Trundle",
      `type`: ctUnit,
      ...
      Card(`set`: Set3, faction: fFreljord, number: 6'u8, subnumber: 2'u8)]), Card(
      `set`: Set3, faction: fFreljord, number: 6'u8, subnumber: 2'u8): CardInfo(
      ...
      spellSpeed: some(ssSlow), supertype: csupChampion, keywords: {Slow}, associatedCards: @[
      Card(`set`: Set3, faction: fFreljord, number: 6'u8, subnumber: 1'u8),
      Card(`set`: Set3, faction: fFreljord, number: 6'u8),
      Card(`set`: Set3, faction: fFreljord, number: 6'u8, subnumber: 2'u8)]), Card(
      `set`: Set3, faction: fFreljord, number: 6'u8, subnumber: 1'u8): CardInfo(
      ...
      `set`: Set3, faction: fFreljord, number: 8'u8): CardInfo(
      name: "Icequake ", `type`: ctSpell,
      description: "Give ALL units -3|-0 this round. Deal 3 to ALL units.",
      flavorText: "\"Bury \'em alive!\" - Trundle", cost: 8, rarity: crEpic,
      spellSpeed: some(ssSlow), keywords: {Slow}), Card(`set`: Set3,
      faction: fFreljord, number: 2'u8): CardInfo(name: "Troll Chant",
      `type`: ctSpell,
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fFreljord, number: 11'u8): CardInfo(
      ...
      faction: fFreljord, number: 5'u8): CardInfo(name: "Troll Ravager",
