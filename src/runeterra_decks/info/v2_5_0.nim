...
const
  runeterraLibraryInternal = {Card(`set`: Set1, faction: fIonia, number: 12): CardInfo(
      ...
      `type`: ctSpell, description: "Create in hand a 6+ cost spell from your regions.\r\nRefill your spell mana.",
      ...
      `type`: ctUnit, description: "Round Start: Grant me +0|+1 for each card you drew last round, then shuffle my stats.\r\n", flavorText: "One prototype spun three bombs and then exploded. Later models had this early \"feature\" removed.",
      ...
      cost: 3, rarity: crCommon, attack: 4, health: 3, supertype: csupChampion,
      keywords: {QuickStrike}, associatedCards: @[
      Card(`set`: Set3, faction: fTargon, number: 217),
      Card(`set`: Set3, faction: fTargon, number: 217, subnumber: 11),
      Card(`set`: Set3, faction: fTargon, number: 217, subnumber: 8),
      ...
      number: 58): CardInfo(name: "Taric", `type`: ctUnit, description: "Support: Give me and my supported ally Tough this round. Copy the last spell you cast on only me this round onto that ally (It can\'t be copied again).", flavorText: "\"Taric\'s gentle kindness inspires all who meet him, galvanizing them to find the warmth within to bolster themselves on even the coldest of nights.\" - Mountain Scryer",
                            cost: 4, rarity: crChampion, attack: 3, health: 4, levelupDescription: "I\'ve seen you target or support allies 7+ times.",
                            supertype: csupChampion, associatedCards: @[
      ...
      name: "Give It All", `type`: ctSpell, description: "Raise all allies\' Power and Health to the highest Power or Health among allies.\r\nGrant all allies allied keywords.", flavorText: "\"I know I know\nYou want some more\nIf you ready let’s go\nGiving it all\"\n- Seraphine, \'MORE\'",
      ...
      name: "Rite of Negation", `type`: ctSpell, description: "Destroy one of your mana gems to stop all enemy Fast spells, Slow spells, and Skills.",
      flavorText: "", cost: 4, rarity: crNone, spellSpeed: some(ssFast),
      keywords: {Fast}), Card(`set`: Set4, faction: fShurima, number: 59,
                              subnumber: 1): CardInfo(name: "Rite of Negation",
      `type`: ctSpell, description: "Kill an ally to stop all enemy Fast spells, Slow spells, and Skills.",
      flavorText: "", cost: 4, rarity: crNone, spellSpeed: some(ssFast),
      keywords: {Fast}), Card(`set`: Set4, faction: fShurima, number: 77): CardInfo(
      ...
      `set`: Set4, faction: fShurima, number: 35): CardInfo(name: "Payday",
      ...
      number: 73): CardInfo(name: "Taliyah", `type`: ctUnit, description: "Play: Summon an exact copy of an allied landmark.", flavorText: "\"The nomad\'s step is always light, for it is unburdened by the weight of roots, and their home is forever beyond the horizon.\"\n- The Societies of Shurima",
                            cost: 5, rarity: crChampion, attack: 2, health: 4, levelupDescription: "You\'ve summoned 5+ landmarks.",
                            supertype: csupChampion, associatedCards: @[
      ...
      faction: fShurima, number: 114): CardInfo(name: "Desert\'s Wrath",
      `type`: ctSpell, description: "Grant allied Sand Soldiers everywhere +1|+0.\r\nSummon 2 Sand Soldiers.", flavorText: "They do not rest. They do not hesitate. They are uncompromising, unfeeling, unyielding.",
      ...
      faction: fShurima, number: 67, subnumber: 5): CardInfo(
      ...
      number: 119): CardInfo(name: "Ricochet", `type`: ctSpell, description: "Reputation: I cost 3. \r\nDeal 1 to a random enemy or the enemy Nexus 5 times.", flavorText: "\"This might get a little messy.\" - Sivir",
                             cost: 6, rarity: crCommon,
      ...
      faction: fShurima, number: 98, subnumber: 6): CardInfo(name: "Lucky Find",
      `type`: ctSpell, description: "+1|+1",
      ...
      spellSpeed: some(ssBurst), keywords: {Focus}), Card(`set`: Set4,
      faction: fShurima, number: 98, subnumber: 10): CardInfo(
      ...
      faction: fShurima, number: 9, subnumber: 1): CardInfo(
      ...
      faction: fShurima, number: 14): CardInfo(name: "Clockling",
      ...
      name: "Ancient Hourglass", `type`: ctSpell, description: "Obliterate an ally to summon a Stasis Statue in its place.", flavorText: "\"Oh, Tai! Come here! We could use your help with something.\"\n- Xetsa, Void Researcher",
      cost: 2, rarity: crRare, spellSpeed: some(ssFast), keywords: {Fast}, associatedCards: @[
      ...
      name: "Restored Sun Disc", `type`: ctLandmark, description: "Immediately draw 1 of all your Ascendants.\r\nFor the rest of the game, your level 2 Ascendants are level 3.", flavorText: "\"Shurima has known no glory like today. Come, bask in the light of our sun!\" - Voice of the Risen",
      cost: 0, rarity: crNone), Card(`set`: Set4, faction: fShurima, number: 18,
                                     subnumber: 2): CardInfo(
      name: "Rite of Dominance", `type`: ctSpell,
      description: "Kill an ally to give all enemies -2|-0 this round.",
      flavorText: "", cost: 4, rarity: crNone, spellSpeed: some(ssFast),
      keywords: {Fast}), Card(`set`: Set4, faction: fShurima, number: 18,
                              subnumber: 1): CardInfo(name: "Rite of Dominance",
      `type`: ctSpell, description: "Destroy one of your mana gems to give all enemies -2|-0 this round.",
      flavorText: "", cost: 4, rarity: crNone, spellSpeed: some(ssFast),
      keywords: {Fast}), Card(`set`: Set4, faction: fShurima, number: 105): CardInfo(
      ...
      Card(`set`: Set4, faction: fShurima, number: 3, subnumber: 14)]), Card(
      `set`: Set4, faction: fShurima, number: 69): CardInfo(
      name: "Ruthless Predator", `type`: ctSpell, description: "Give an ally +2|+0 to give an enemy Vulnerable this round.",
      ...
      flavorText: "", cost: 0, rarity: crNone, spellSpeed: some(ssSlow),
      keywords: {Slow}), Card(`set`: Set4, faction: fShurima, number: 121,
                              subnumber: 2): CardInfo(name: "Rite of Calling",
      `type`: ctSpell, description: "Kill an ally to draw a Champion.",
      flavorText: "", cost: 0, rarity: crNone, spellSpeed: some(ssSlow),
      keywords: {Slow}), Card(`set`: Set4, faction: fShurima, number: 97,
                              subnumber: 1): CardInfo(
      ...
      `type`: ctSpell,
      description: "Obliterate a unit to summon a Frozen Tomb in its place.",
      ...
      cost: 4, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set4, faction: fNoxus, number: 6): CardInfo(name: "Black Rose Spy",
      ...
      number: 17): CardInfo(name: "Song of the Isles", `type`: ctSpell, description: "Grant an ally Lifesteal, Fearsome, and Ephemeral.", flavorText: "\"Come, child. See as I see, and feel as I feel. Do not fear the darkness.\" - The Rekindler",
                            cost: 2, rarity: crCommon,
                            spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      ...
      faction: fShadowIsles, number: 2): CardInfo(name: "Spirit Journey",
      `type`: ctSpell, description: "Kill a unit, then revive it.",
      flavorText: "\"This is only an interlude.\" - Lamb", cost: 5,
      rarity: crRare, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      ...
      cost: 8, rarity: crEpic, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set4, faction: fDemacia, number: 14): CardInfo(name: "Dragon Chow",
      `type`: ctUnit,
      ...
      cost: 6, rarity: crChampion, attack: 6, health: 4, levelupDescription: "Allies have survived 4+ strikes from enemy blockers.",
      ...
      cost: 4, rarity: crEpic, attack: 1, health: 4, keywords: {Attune})}.toTable
