...
const
  runeterraLibraryInternal = {Card(`set`: Set1, faction: fIonia, number: 12): CardInfo(
      ...
      spellSpeed: some(ssFast), keywords: {Fast}), Card(`set`: Set1,
      faction: fShadowIsles, number: 11): CardInfo(name: "Ravenous Butcher",
      `type`: ctUnit, description: "To play me, kill an ally.",
      flavorText: "You are what you eat.", cost: 0, rarity: crCommon, attack: 3,
      health: 2), Card(`set`: Set1, faction: fShadowIsles, number: 14): CardInfo(
      ...
      cost: 6, rarity: crRare, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set1, faction: fShadowIsles, number: 46): CardInfo(
      ...
      `type`: ctSpell, description: "Shuffle a unit or landmark into its deck.", flavorText: "\"Now, I delivered to you exactly what you wanted, friend. I never said it would last forever.\" - Tahm Kench",
      ...
      faction: fBilgewater, number: 8): CardInfo(name: "Fortune Croaker",
      ...
      cost: 1, rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fPiltoverZaun, number: 19): CardInfo(
      ...
      `set`: Set3, faction: fPiltoverZaun, number: 17): CardInfo(
      ...
      `type`: ctSpell, description: "Drain 1 from a unit and shuffle 2 copies of me into your deck. Once you\'ve cast me 3 times, transform all copies of me everywhere into Pack Your Bags. ", flavorText: "\"We go hard, \'til we get it, get it\nWe go hard, we so in it, in it\nWe Pop Stars (Pop Stars), only winning, winning now\nAin\'t nobody bringing us down, down, down, down\"\n- Evelynn, \'POP/STARS\'",
      ...
      cost: 1, rarity: crNone, spellSpeed: some(ssSlow), keywords: {Slow},
      ...
      `set`: Set3, faction: fShadowIsles, number: 6, subnumber: 1): CardInfo(
      ...
      `set`: Set3, faction: fTargon, number: 15): CardInfo(
      ...
      cost: 2, rarity: crCommon, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 85): CardInfo(name: "Hush",
      `type`: ctSpell, description: "Silence a unit this round.",
      flavorText: "\"They will know serenity.\" - Soraka", cost: 2,
      rarity: crRare, spellSpeed: some(ssBurst), keywords: {Burst}), Card(
      `set`: Set3, faction: fTargon, number: 1, subnumber: 1): CardInfo(
      ...
      faction: fTargon, number: 8): CardInfo(name: "Wish", `type`: ctSpell,
      ...
      `set`: Set3, faction: fTargon, number: 110): CardInfo(
      ...
      rarity: crCommon, attack: 1, health: 1, subtypes: {csubPoro},
      keywords: {SpellShield}), Card(`set`: Set3, faction: fDemacia, number: 8): CardInfo(
      ...
      faction: fTargon, number: 5): CardInfo(name: "Divergent Paths",
      ...
      `set`: Set3, faction: fNoxus, number: 13): CardInfo(
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set3, faction: fNoxus, number: 4): CardInfo(name: "Noxkraya Arena",
      ...
      cost: 3, rarity: crCommon, spellSpeed: some(ssFast), keywords: {Fast}), Card(
      `set`: Set3, faction: fShadowIsles, number: 8): CardInfo(name: "Crumble",
      `type`: ctSpell,
      ...
      cost: 12, rarity: crEpic, spellSpeed: some(ssSlow), keywords: {Slow}), Card(
      `set`: Set3, faction: fNoxus, number: 18): CardInfo(name: "Apprehend",
      `type`: ctSpell,
